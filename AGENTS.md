...
- 当前 Phase：`Phase 1A`
- 当前 Step：`T-P1A-011C auth-present metadata probe done`
- 当前活动任务：`T-P1A-011C`（done；当前无 active product task）；Active count=`0/3`，Review count=`0`
...
- 当前只做：等待 user 是否授权下一步 evidence-consumption gate；不从聊天摘要自动启动新任务
