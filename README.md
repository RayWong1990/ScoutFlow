...
- 当前焦点：`T-P1A-008` BBDown sanitized fixture parser 已由 Dispatch 3 显式打开；只做 fixture-only parser / classifier
...
- 当前 code-bearing task 仅为 `T-P1A-008`；允许路径限制在 `services/api/scoutflow_api/external_tools/**`、`tests/contracts/**`、`tests/fixtures/bbdown/**` 和必要账本同步文件
- `T-P1A-008` 不批准 BBDown runtime、真实 Bilibili URL、媒体下载、ffmpeg、ASR、workers 或 frontend
