...
- 当前焦点：Wave 1 ledger 已打开，`T-P1A-010A` / `T-P1A-010B` / `T-P1A-010C` 为 active；Active count=`3/3`
- 当前不做：workers / frontend / 浏览器自动化 / 真实下载 / 真实 BBDown 执行 / yt-dlp runtime / ffmpeg runtime / ASR / `audio_transcript` runtime
...
- 当前 active tasks：`T-P1A-010A` BBDown tool preflight、`T-P1A-010B` injected-runner `-info` adapter shell、`T-P1A-010C` PRD/SRD repair pack；具体 allowed paths 以 `docs/task-index.md` 为准
- `T-P1A-008` 仅表示 fixture-only parser / classifier baseline merged，不批准 broader BBDown runtime、媒体下载、ffmpeg、ASR、workers 或 frontend；`T-P1A-009` 和 `T-P1A-010` 也不构成正式 adapter runtime approval
