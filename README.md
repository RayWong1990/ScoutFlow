...
- 当前焦点：已合入 `T-P1A-006` BBDown adapter draft spec 与 `T-P1A-007` Explore URL UX research note；下一步候选为 `T-P1A-008`
...
- 当前无自动打开的 code-bearing task；继续开工需以新 dispatch 为准
- `services/api/**` 与 `tests/**` 已有 Phase 1A baseline，但 `T-P1A-008` 未显式打开前，不开放代码修改
