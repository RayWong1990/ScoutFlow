...
- 当前焦点：Wave 1 ledger 已收口；`T-P1A-011` preflight compatibility repair 已完成；Active count=`0/3`，Review count=`0`
...
- 当前 active tasks：无；`T-P1A-011` preflight compatibility repair 已完成；若未来重跑 `-info`，仍需 user 再次显式授权
