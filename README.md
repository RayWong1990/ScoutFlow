...
- 当前焦点：`T-P1A-008` BBDown sanitized fixture parser 已通过 PR `#17` 合入 `main`；`T-P1A-009` 仍为 backlog/gated
...
- 当前无 active code-bearing task；继续开工需以新 dispatch 为准
- `T-P1A-008` 仅表示 fixture-only parser / classifier baseline merged，不批准 BBDown runtime、真实 Bilibili URL、媒体下载、ffmpeg、ASR、workers 或 frontend
