...
推荐路径: RI spec → backup/rollback spec → locked DTO guard → Hermes → explicit user gate → migration PR skeleton → phased rollout。
...
4. D-MIG-004 只在 1-3 完成后形成 spec PR skeleton。
5. D-MIG-007 负责分阶段 rollout, 防止 dev pass 泛化。
...
- self-verification:
  ...
  - Hermes can audit
  - candidate label intact
### D-MIG-004 — dbvnext_migration authority 升级 PR
- id: `D-MIG-004`
- status: candidate
- parent_lane: `dbvnext_migration`
- dependency: D-MIG-001~003 + backup evidence
- TL;DR: 合成 spec PR skeleton, 明确 migration 仍需 user gate 与 Hermes V-PASS。
- 输入包:
  - https://raw.githubusercontent.com/RayWong1990/ScoutFlow/main/docs/COLLECTION-LINE-MASTER-SPEC-2026-05-07.md
  - https://raw.githubusercontent.com/RayWong1990/ScoutFlow/main/docs/00-START-HERE.md
  - https://raw.githubusercontent.com/RayWong1990/ScoutFlow/main/docs/current.md
