# PF-C0-04 — Preview-only localhost scope note

```yaml
status: deprecated_by_PF_META_01
deprecated_at: 2026-05-06
superseded_by: PF-C0-MERGED-03+04
deprecation_reason: preview-only scope merged into successor entry and preview-only scope memo
pack: PF-C0-O1-successor-entry-pack
legacy_code: PF-C0-04
```
...
`docs/research/post-frozen/preview-only-localhost-scope-note.md`
...
Defines A-tier target: localhost paste URL -> preview markdown -> copy/download; excludes true write/runtime.
