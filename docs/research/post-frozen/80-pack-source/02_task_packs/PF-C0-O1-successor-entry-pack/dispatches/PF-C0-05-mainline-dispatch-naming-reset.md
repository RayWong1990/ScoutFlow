# PF-C0-05 — Mainline dispatch naming reset

```yaml
status: deprecated_by_PF_META_01
deprecated_at: 2026-05-06
superseded_by: PF-C0-MERGED-03+04
deprecation_reason: dispatch naming reset belongs inside the successor entry memo
pack: PF-C0-O1-successor-entry-pack
legacy_code: PF-C0-05
```
...
`docs/research/post-frozen/mainline-dispatch-naming-reset.md`
...
Introduces PF-* dispatch group names and prohibits treating Dispatch177+ as automatic sequence.
