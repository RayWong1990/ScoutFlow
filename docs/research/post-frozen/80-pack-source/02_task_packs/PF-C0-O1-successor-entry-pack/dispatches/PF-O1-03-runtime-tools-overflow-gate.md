# PF-O1-03 — Runtime tools overflow gate

```yaml
status: deprecated_by_PF_META_01
deprecated_at: 2026-05-06
superseded_by: PF-O1-01R row 2
deprecation_reason: runtime tools are represented as row 2 in the overflow registry
pack: PF-C0-O1-successor-entry-pack
legacy_code: PF-O1-03
```
...
`docs/research/post-frozen/overflow-runtime-tools-gate.md`
...
BBDown live / yt-dlp / ffmpeg / ASR / audio_transcript all stay overflow with reopen evidence.
