# PF-O1-04 — Browser automation overflow gate

```yaml
status: deprecated_by_PF_META_01
deprecated_at: 2026-05-06
superseded_by: PF-O1-01R row 3
deprecation_reason: browser automation is represented as row 3 in the overflow registry
pack: PF-C0-O1-successor-entry-pack
legacy_code: PF-O1-04
```
...
`docs/research/post-frozen/overflow-browser-automation-gate.md`
...
Browser automation and Playwright execution are blocked until screenshot/human visual gate passes.
