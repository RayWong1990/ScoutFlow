# PF-O1-05 — DBvNext and migration overflow gate

```yaml
status: deprecated_by_PF_META_01
deprecated_at: 2026-05-06
superseded_by: PF-O1-01R row 4
deprecation_reason: DBvNext and migration are represented as row 4 in the overflow registry
pack: PF-C0-O1-successor-entry-pack
legacy_code: PF-O1-05
```
...
`docs/research/post-frozen/overflow-db-migration-gate.md`
...
DBvNext remains candidate-only and migrations remain forbidden without explicit dispatch + human approval.
