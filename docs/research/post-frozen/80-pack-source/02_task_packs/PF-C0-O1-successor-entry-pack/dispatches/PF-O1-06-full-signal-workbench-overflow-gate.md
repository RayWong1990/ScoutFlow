# PF-O1-06 — Full Signal Workbench overflow gate

```yaml
status: deprecated_by_PF_META_01
deprecated_at: 2026-05-06
superseded_by: PF-O1-01R row 5
deprecation_reason: full Signal Workbench is represented as row 5 in the overflow registry
pack: PF-C0-O1-successor-entry-pack
legacy_code: PF-O1-06
```
...
`docs/research/post-frozen/overflow-full-signal-workbench-gate.md`
...
Full Signal Workbench/ranking/scoring engine cannot enter mainline before topic-card-lite proof.
