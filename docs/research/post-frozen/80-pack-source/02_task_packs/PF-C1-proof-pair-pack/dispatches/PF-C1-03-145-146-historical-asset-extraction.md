# PF-C1-03 — 145-146 historical asset extraction
...
`docs/research/post-frozen/topic-card-preview-vault-historical-asset-extraction.md`
...
Extracts ideas from historical T-P1A-124/125 without calling them active dispatch or proof pass.
