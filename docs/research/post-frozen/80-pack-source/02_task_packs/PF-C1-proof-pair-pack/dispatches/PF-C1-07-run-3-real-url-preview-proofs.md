# PF-C1-07 — Run 3 real URL preview proofs
...
`docs/research/post-frozen/c1-three-url-preview-proof-set.md`
...
3 canary URLs produce preview markdown + topic-card-lite artifacts; failures documented.
