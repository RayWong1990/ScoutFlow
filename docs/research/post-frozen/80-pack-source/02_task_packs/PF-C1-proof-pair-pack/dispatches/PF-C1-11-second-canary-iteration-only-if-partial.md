# PF-C1-11 — Second canary iteration only if partial
...
`docs/research/post-frozen/c1-second-canary-iteration.md`
...
If C1 partial, run at most 2 new URLs to isolate failure; no broad expansion.
