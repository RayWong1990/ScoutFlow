# PF-C2-01 — RAW note candidate contract v0
...
`docs/specs/post-frozen/raw-note-candidate-contract-v0.md`
...
Defines raw 4-field frontmatter + ScoutFlow preview body sections without changing RAW taxonomy.
