# PF-C2-02 — RAW frontmatter compatibility check
...
`docs/research/post-frozen/raw-frontmatter-compatibility-check.md`
...
Checks generated note fields against RAW template assumptions; not a RAW schema change.
