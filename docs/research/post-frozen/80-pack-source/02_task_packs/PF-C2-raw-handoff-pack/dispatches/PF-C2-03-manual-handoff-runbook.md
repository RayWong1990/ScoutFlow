# PF-C2-03 — Manual handoff runbook
...
`docs/research/post-frozen/manual-raw-handoff-runbook.md`
...
Explains manual transfer from H5 preview/download to RAW 00-Inbox without true ScoutFlow vault write.
