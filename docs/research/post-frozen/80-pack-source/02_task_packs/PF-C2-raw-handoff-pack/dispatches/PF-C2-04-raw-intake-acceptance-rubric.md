# PF-C2-04 — RAW intake acceptance rubric
...
`docs/research/post-frozen/raw-intake-acceptance-rubric.md`
...
Defines accepted/needs-edit/rejected; must distinguish second inbox from consumed note.
