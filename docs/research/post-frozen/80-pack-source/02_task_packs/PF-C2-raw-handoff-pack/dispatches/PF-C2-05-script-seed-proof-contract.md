# PF-C2-05 — Script seed proof contract
...
`docs/specs/post-frozen/script-seed-proof-contract.md`
...
Defines what counts as downstream paragraph/script seed and what does not.
