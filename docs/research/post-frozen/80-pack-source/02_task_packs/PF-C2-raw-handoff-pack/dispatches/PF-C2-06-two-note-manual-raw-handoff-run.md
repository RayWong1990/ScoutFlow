# PF-C2-06 — Two-note manual RAW handoff run
...
proof_kind: raw_intake
human_gate: raw_handoff_permission
can_parallel: no
serial_gate: none
```
...
`docs/research/post-frozen/c2-two-note-manual-raw-handoff-run.md`
...
At least two useful C1 previews are manually handed to RAW 00-Inbox or equivalent staging and logged.
