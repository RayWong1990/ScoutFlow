# PF-C2-07 — RAW intake/readback result
...
`docs/research/post-frozen/c2-raw-intake-readback-result.md`
...
Records RAW acceptance/needs-edit/reject for each note; must include reason.
