# PF-C2-09 — Second-inbox negative test
...
`docs/research/post-frozen/c2-second-inbox-negative-test.md`
...
Fails if notes just accumulate in inbox without intake or seed; pass requires consumption evidence.
