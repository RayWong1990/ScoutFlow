# PF-C2-10 — ScoutFlow/RAW SoR handoff matrix update
...
`docs/research/post-frozen/scoutflow-raw-sor-handoff-matrix.md`
...
Matrix states ScoutFlow owns preview/evidence; RAW owns intake/compile/script; no dual SoR.
