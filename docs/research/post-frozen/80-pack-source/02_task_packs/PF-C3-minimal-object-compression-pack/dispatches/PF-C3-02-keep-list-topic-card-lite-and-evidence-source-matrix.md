# PF-C3-02 — Keep-list: topic-card-lite and evidence-source matrix
...
`docs/research/post-frozen/c3-object-keep-list.md`
...
Only proof-serving objects remain independently visible.
