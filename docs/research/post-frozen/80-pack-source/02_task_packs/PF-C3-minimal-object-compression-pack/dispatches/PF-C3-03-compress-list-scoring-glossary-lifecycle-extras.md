# PF-C3-03 — Compress-list: scoring/glossary/lifecycle extras

```yaml
status: candidate_task_draft_not_authority
pack: PF-C3-minimal-object-compression-pack
cluster: PF-C3
dispatch_class: audit
open_after_state: parallel_prep_after_successor_entry
...
`docs/research/post-frozen/c3-object-compress-list.md`
...
Over-objectified docs become appendices or reservoir inputs, not mainline dependencies.
