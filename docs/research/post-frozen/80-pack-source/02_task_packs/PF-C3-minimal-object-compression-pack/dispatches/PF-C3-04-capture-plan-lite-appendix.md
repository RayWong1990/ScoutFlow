# PF-C3-04 — Capture-plan-lite appendix
...
`docs/specs/post-frozen/capture-plan-lite-appendix.md`
...
If C1 pass, capture-plan-lite appendix supports next URL selection without becoming a full planner.
