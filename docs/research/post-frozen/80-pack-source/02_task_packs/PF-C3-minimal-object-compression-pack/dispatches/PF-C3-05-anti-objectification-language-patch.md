# PF-C3-05 — Anti-objectification language patch
...
`docs/research/post-frozen/anti-objectification-language-patch.md`
...
Future task templates say object existence != product proof.
