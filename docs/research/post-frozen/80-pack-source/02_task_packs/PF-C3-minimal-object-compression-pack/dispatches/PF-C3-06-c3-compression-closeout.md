# PF-C3-06 — C3 compression closeout
...
`docs/research/post-frozen/c3-compression-closeout.md`
...
Closeout states what stays live vs overflow; does not delete historical evidence.
