# PF-C4-02 — Screenshot packet after localhost proof
...
proof_kind: screenshot_visual
human_gate: visual_verdict
can_parallel: yes
serial_gate: none
```
...
`docs/visual/h5-capture-station/post-frozen/localhost-preview-screenshot-packet.md`
...
- `docs/visual/h5-capture-station/post-frozen/**`
...
Screenshot set captures URL input, loading, preview, copy/download states; no Playwright claim required.
