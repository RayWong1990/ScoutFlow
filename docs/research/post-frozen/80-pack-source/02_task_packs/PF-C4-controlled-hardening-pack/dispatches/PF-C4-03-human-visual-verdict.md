...
`docs/visual/h5-capture-station/post-frozen/human-visual-verdict.md`
...
Human verdict covers hierarchy, alignment, occlusion, readability, visual weight, and task usefulness.
