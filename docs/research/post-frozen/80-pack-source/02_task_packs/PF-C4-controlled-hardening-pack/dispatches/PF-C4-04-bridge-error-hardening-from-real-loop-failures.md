# PF-C4-04 — Bridge error hardening from real loop failures
...
- `services/api/scoutflow_api/bridge/**`
- `tests/**`
...
Only fixes errors observed in preview loop; does not add true write/runtime.
