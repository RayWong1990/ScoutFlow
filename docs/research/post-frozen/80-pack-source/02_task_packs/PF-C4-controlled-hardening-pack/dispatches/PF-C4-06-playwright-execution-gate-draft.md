# PF-C4-06 — Playwright execution gate draft
...
`docs/visual/h5-capture-station/post-frozen/playwright-execution-gate-draft.md`
...
Defines when browser automation may be run; does not run it.
