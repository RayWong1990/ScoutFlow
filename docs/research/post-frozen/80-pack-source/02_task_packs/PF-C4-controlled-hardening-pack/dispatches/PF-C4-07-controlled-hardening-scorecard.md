# PF-C4-07 — Controlled hardening scorecard
...
`docs/research/post-frozen/controlled-hardening-scorecard.md`
...
Scorecard proves hardening served A/B loop and did not expand scope.
