# PF-LP-15 — Frontend component tests for preview loop
...
`apps/capture-station/src/features/vault-preview/VaultPreviewPanel.test.tsx`
...
- `apps/capture-station/src/layout/**`
...
Vitest component tests prove submit -> preview visible -> copy/download controls enabled using mocked fetch.
