# PF-LP-16 — Manual localhost run evidence note
...
human_gate: none
can_parallel: no
serial_gate: PF-LP implementation must merge first
```
...
`docs/research/post-frozen/localhost-preview-manual-run-evidence.md`
...
Manual run note records exact URL, capture_id, screenshot optional, markdown excerpt, copy/download result.
