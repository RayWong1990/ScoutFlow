# PF-GLOBAL-01 — Global 80-file manifest verifier
...
`tools/check-successor-pack-manifest.py`
...
Verifies all authored tasks include cluster, proof_kind, open_after_state, human_gate, blocked_claims.
