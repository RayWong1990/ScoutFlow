# PF-GLOBAL-02 — Commander prompt draft for near-term 20-30
...
`docs/research/post-frozen/commander-prompt-near-term-mainline.md`
...
Commander prompt opens only C0/O1 + localhost preview; parks remaining reservoir.
