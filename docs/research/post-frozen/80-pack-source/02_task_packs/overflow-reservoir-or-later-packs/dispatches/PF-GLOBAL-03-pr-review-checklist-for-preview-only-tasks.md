# PF-GLOBAL-03 — PR review checklist for preview-only tasks
...
`docs/research/post-frozen/pr-review-checklist-preview-only.md`
...
Checklist prevents review from accepting placeholder or docs-only output as proof.
