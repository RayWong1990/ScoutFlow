# PF-GLOBAL-04 — Proof scorecard schema
...
`docs/research/post-frozen/proof-scorecard-schema.md`
...
Schema separates shape_only/preview_only/real_url/human/raw_intake/script_seed/screenshot proof kinds.
