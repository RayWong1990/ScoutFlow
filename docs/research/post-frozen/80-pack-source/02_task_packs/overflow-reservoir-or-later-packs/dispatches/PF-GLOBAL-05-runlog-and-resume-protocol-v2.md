# PF-GLOBAL-05 — Runlog and resume protocol v2
...
`docs/research/post-frozen/runlog-resume-protocol-v2.md`
...
Protocol learned from Dispatch127-176: checkpoint/live PR truth must be reconciled before resume.
