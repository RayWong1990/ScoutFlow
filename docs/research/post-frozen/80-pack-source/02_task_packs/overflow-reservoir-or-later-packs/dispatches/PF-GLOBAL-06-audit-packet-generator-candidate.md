# PF-GLOBAL-06 — Audit packet generator candidate
...
`docs/research/post-frozen/audit-packet-generator-candidate.md`
...
Defines minimal audit packet for localhost proof without copying secrets/RAW credential material.
