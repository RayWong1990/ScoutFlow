# PF-GLOBAL-07 — Branch grouping and PR naming policy
...
`docs/research/post-frozen/branch-grouping-pr-naming-policy.md`
...
Names branches by PF cluster and prevents hidden linear 177+ framing.
