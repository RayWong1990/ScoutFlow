# PF-GLOBAL-09 — Kill-switch registry test packet
...
`docs/research/post-frozen/kill-switch-registry-test-packet.md`
...
Tests task texts against known bad claims: preview=closed, docs=proof, checklist=visual, runtime creep.
