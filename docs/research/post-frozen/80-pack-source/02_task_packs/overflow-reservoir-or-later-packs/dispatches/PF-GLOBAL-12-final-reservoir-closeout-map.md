# PF-GLOBAL-12 — Final reservoir closeout map
...
`docs/research/post-frozen/final-reservoir-closeout-map.md`
...
Maps all 80 tasks into near-term/open/gated/overflow; no automatic execution.
