---
title: "ILL01 Illustration Spec — station-hero / url-panel-hero"
...
# ILL01 Illustration Spec — station-hero / url-panel-hero
...
## Illustration `station-hero`

| Field | Value |
|---|---|
| illustration_id | `station-hero` |
| intent | Hero illustration for full operator workstation |
| concept | four-panel shell with deep blue slab |
| linked_state | `idle / ready / candidate / future_gate / blocked` as applicable |
| linked_visual_asset | `U4:station-hero` pending external refresh |
...
## Illustration `url-panel-hero`

| Field | Value |
|---|---|
| illustration_id | `url-panel-hero` |
| intent | URL Bar hero |
| concept | manual URL input and bounded action |
| linked_state | `idle / ready / candidate / future_gate / blocked` as applicable |
| linked_visual_asset | `U4:url-panel-hero` pending external refresh |
| license | ScoutFlow-original candidate geometry; no third-party art copied |
| format | Inline SVG concept, scalable |
...
### ILL01 Illustration Spec — station-hero / url-panel-hero — audit expansion 1
...
本节适用于 `ILL01 Illustration Spec — station-hero / url-panel-hero`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### ILL01 Illustration Spec — station-hero / url-panel-hero — audit expansion 2
...
### ILL01 Illustration Spec — station-hero / url-panel-hero — audit expansion 3
...
### ILL01 Illustration Spec — station-hero / url-panel-hero — audit expansion 4
...
### ILL01 Illustration Spec — station-hero / url-panel-hero — audit expansion 5
...
### ILL01 Illustration Spec — station-hero / url-panel-hero — audit expansion 6
