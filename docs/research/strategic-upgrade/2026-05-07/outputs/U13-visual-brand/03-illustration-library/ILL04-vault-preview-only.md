---
title: "ILL04 Illustration Spec — vault-preview-only / blocked-lane-spot"
...
# ILL04 Illustration Spec — vault-preview-only / blocked-lane-spot
...
## Illustration `vault-preview-only`

| Field | Value |
|---|---|
| illustration_id | `vault-preview-only` |
| intent | Vault preview only |
| concept | preview shelf with lock |
| linked_state | `idle / ready / candidate / future_gate / blocked` as applicable |
| linked_visual_asset | `U4:vault-preview-only` pending external refresh |
...
<svg viewBox="0 0 640 360" role="img" aria-hidden="true" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M48 122H320V162H48Z" fill="#0B1624" stroke="#3A5879" stroke-width="2"/>
  <path d="M48 188H260V228H48Z" fill="#10233D" stroke="#27415D" stroke-width="2"/>
...
## Illustration `blocked-lane-spot`

| Field | Value |
|---|---|
| illustration_id | `blocked-lane-spot` |
| intent | Blocked lane spot |
| concept | visible but downgraded future capability |
| linked_state | `idle / ready / candidate / future_gate / blocked` as applicable |
| linked_visual_asset | `U4:blocked-lane-spot` pending external refresh |
| license | ScoutFlow-original candidate geometry; no third-party art copied |
| format | Inline SVG concept, scalable |
...
<svg viewBox="0 0 640 360" role="img" aria-hidden="true" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M32 300H608V64H32Z" fill="#07111B"/>
  <path d="M64 92H576V280H64Z" fill="#111F31" stroke="#27415D" stroke-width="3"/>
  <path d="M56 122H320V162H56Z" fill="#0B1624" stroke="#3A5879" stroke-width="2"/>
  <path d="M56 188H260V228H56Z" fill="#10233D" stroke="#27415D" stroke-width="2"/>
  <path d="M360 118H520V240H360Z" fill="#0B1624" stroke="#50D4FF" stroke-width="3"/>
  <path d="M384 156H496 M384 188H476 M384 220H456" stroke="#A6B8CF" stroke-width="6" stroke-linecap="round"/>
  <path d="M86 302C152 250 226 252 288 302C354 354 478 348 568 302" stroke="#50D4FF" stroke-opacity=".45" stroke-width="4"/>
</svg>
...
### ILL04 Illustration Spec — vault-preview-only / blocked-lane-spot — audit expansion 1
...
本节适用于 `ILL04 Illustration Spec — vault-preview-only / blocked-lane-spot`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### ILL04 Illustration Spec — vault-preview-only / blocked-lane-spot — audit expansion 2
...
### ILL04 Illustration Spec — vault-preview-only / blocked-lane-spot — audit expansion 3
...
### ILL04 Illustration Spec — vault-preview-only / blocked-lane-spot — audit expansion 4
...
### ILL04 Illustration Spec — vault-preview-only / blocked-lane-spot — audit expansion 5
...
### ILL04 Illustration Spec — vault-preview-only / blocked-lane-spot — audit expansion 6
