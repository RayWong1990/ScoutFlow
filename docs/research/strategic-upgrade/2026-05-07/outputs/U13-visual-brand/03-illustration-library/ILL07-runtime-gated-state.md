---
title: "ILL07 Illustration Spec — runtime-gated-state / browser-gated-state"
...
# ILL07 Illustration Spec — runtime-gated-state / browser-gated-state
...
## Illustration `runtime-gated-state`

| Field | Value |
|---|---|
| illustration_id | `runtime-gated-state` |
| intent | Runtime gated spot |
| concept | no BBDown/live runtime implied |
| linked_state | `idle / ready / candidate / future_gate / blocked` as applicable |
| linked_visual_asset | `U4:runtime-gated-state` pending external refresh |
...
## Illustration `browser-gated-state`

| Field | Value |
|---|---|
| illustration_id | `browser-gated-state` |
| intent | Browser automation gated |
| concept | future-gated screenshot lane |
| linked_state | `idle / ready / candidate / future_gate / blocked` as applicable |
| linked_visual_asset | `U4:browser-gated-state` pending external refresh |
| license | ScoutFlow-original candidate geometry; no third-party art copied |
| format | Inline SVG concept, scalable |
...
### ILL07 Illustration Spec — runtime-gated-state / browser-gated-state — audit expansion 1
...
本节适用于 `ILL07 Illustration Spec — runtime-gated-state / browser-gated-state`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### ILL07 Illustration Spec — runtime-gated-state / browser-gated-state — audit expansion 2
...
### ILL07 Illustration Spec — runtime-gated-state / browser-gated-state — audit expansion 3
...
### ILL07 Illustration Spec — runtime-gated-state / browser-gated-state — audit expansion 4
...
### ILL07 Illustration Spec — runtime-gated-state / browser-gated-state — audit expansion 5
...
### ILL07 Illustration Spec — runtime-gated-state / browser-gated-state — audit expansion 6
