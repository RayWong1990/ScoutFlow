---
title: "ILL08 Illustration Spec — visual-audit-room / phase-spine"
...
# ILL08 Illustration Spec — visual-audit-room / phase-spine
...
## Illustration `visual-audit-room`

| Field | Value |
|---|---|
| illustration_id | `visual-audit-room` |
| intent | Visual audit room |
| concept | five gate cards in review |
| linked_state | `idle / ready / candidate / future_gate / blocked` as applicable |
| linked_visual_asset | `U4:visual-audit-room` pending external refresh |
...
## Illustration `phase-spine`

| Field | Value |
|---|---|
| illustration_id | `phase-spine` |
| intent | Phase evolution spine |
| concept | U4 -> U7 -> U13 -> PF-V |
| linked_state | `idle / ready / candidate / future_gate / blocked` as applicable |
| linked_visual_asset | `U4:phase-spine` pending external refresh |
| license | ScoutFlow-original candidate geometry; no third-party art copied |
| format | Inline SVG concept, scalable |
...
### ILL08 Illustration Spec — visual-audit-room / phase-spine — audit expansion 1
...
本节适用于 `ILL08 Illustration Spec — visual-audit-room / phase-spine`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### ILL08 Illustration Spec — visual-audit-room / phase-spine — audit expansion 2
...
### ILL08 Illustration Spec — visual-audit-room / phase-spine — audit expansion 3
...
### ILL08 Illustration Spec — visual-audit-room / phase-spine — audit expansion 4
...
### ILL08 Illustration Spec — visual-audit-room / phase-spine — audit expansion 5
...
### ILL08 Illustration Spec — visual-audit-room / phase-spine — audit expansion 6
