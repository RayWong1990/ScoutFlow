---
title: "ILL11 Illustration Spec — h5-responsive-stack / operator-focus"
...
# ILL11 Illustration Spec — h5-responsive-stack / operator-focus
...
## Illustration `h5-responsive-stack`

| Field | Value |
|---|---|
| illustration_id | `h5-responsive-stack` |
| intent | Responsive H5 stack |
| concept | desktop/tablet/mobile panels |
| linked_state | `idle / ready / candidate / future_gate / blocked` as applicable |
| linked_visual_asset | `U4:h5-responsive-stack` pending external refresh |
...
<svg viewBox="0 0 640 360" role="img" aria-hidden="true" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M40 122H320V162H40Z" fill="#0B1624" stroke="#3A5879" stroke-width="2"/>
  <path d="M40 188H260V228H40Z" fill="#10233D" stroke="#27415D" stroke-width="2"/>
...
## Illustration `operator-focus`

| Field | Value |
|---|---|
| illustration_id | `operator-focus` |
| intent | Operator focus spot |
| concept | single-user local-first posture |
| linked_state | `idle / ready / candidate / future_gate / blocked` as applicable |
| linked_visual_asset | `U4:operator-focus` pending external refresh |
| license | ScoutFlow-original candidate geometry; no third-party art copied |
| format | Inline SVG concept, scalable |
...
### ILL11 Illustration Spec — h5-responsive-stack / operator-focus — audit expansion 1
...
本节适用于 `ILL11 Illustration Spec — h5-responsive-stack / operator-focus`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### ILL11 Illustration Spec — h5-responsive-stack / operator-focus — audit expansion 2
...
### ILL11 Illustration Spec — h5-responsive-stack / operator-focus — audit expansion 3
...
### ILL11 Illustration Spec — h5-responsive-stack / operator-focus — audit expansion 4
...
### ILL11 Illustration Spec — h5-responsive-stack / operator-focus — audit expansion 5
...
### ILL11 Illustration Spec — h5-responsive-stack / operator-focus — audit expansion 6
