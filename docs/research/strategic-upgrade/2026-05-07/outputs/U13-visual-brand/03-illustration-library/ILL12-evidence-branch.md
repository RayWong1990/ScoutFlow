---
title: "ILL12 Illustration Spec — evidence-branch / receipt-ledger-spot"
...
# ILL12 Illustration Spec — evidence-branch / receipt-ledger-spot
...
## Illustration `evidence-branch`

| Field | Value |
|---|---|
| illustration_id | `evidence-branch` |
| intent | Evidence branch |
| concept | failure branch off main proof chain |
| linked_state | `idle / ready / candidate / future_gate / blocked` as applicable |
| linked_visual_asset | `U4:evidence-branch` pending external refresh |
...
## Illustration `receipt-ledger-spot`

| Field | Value |
|---|---|
| illustration_id | `receipt-ledger-spot` |
| intent | Receipt ledger spot |
| concept | audit/provenance shelf |
| linked_state | `idle / ready / candidate / future_gate / blocked` as applicable |
| linked_visual_asset | `U4:receipt-ledger-spot` pending external refresh |
| license | ScoutFlow-original candidate geometry; no third-party art copied |
| format | Inline SVG concept, scalable |
...
### ILL12 Illustration Spec — evidence-branch / receipt-ledger-spot — audit expansion 1
...
本节适用于 `ILL12 Illustration Spec — evidence-branch / receipt-ledger-spot`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### ILL12 Illustration Spec — evidence-branch / receipt-ledger-spot — audit expansion 2
...
### ILL12 Illustration Spec — evidence-branch / receipt-ledger-spot — audit expansion 3
...
### ILL12 Illustration Spec — evidence-branch / receipt-ledger-spot — audit expansion 4
...
### ILL12 Illustration Spec — evidence-branch / receipt-ledger-spot — audit expansion 5
...
### ILL12 Illustration Spec — evidence-branch / receipt-ledger-spot — audit expansion 6
