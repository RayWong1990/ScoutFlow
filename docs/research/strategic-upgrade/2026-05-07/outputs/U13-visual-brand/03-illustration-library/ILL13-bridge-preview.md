---
title: "ILL13 Illustration Spec — bridge-preview / raw-inbox"
...
# ILL13 Illustration Spec — bridge-preview / raw-inbox
...
## Illustration `bridge-preview`

| Field | Value |
|---|---|
| illustration_id | `bridge-preview` |
| intent | Bridge preview spot |
| concept | route group and preview contract |
| linked_state | `idle / ready / candidate / future_gate / blocked` as applicable |
| linked_visual_asset | `U4:bridge-preview` pending external refresh |
...
## Illustration `raw-inbox`

| Field | Value |
|---|---|
| illustration_id | `raw-inbox` |
| intent | RAW inbox destination |
| concept | PARA inbox not direct authority write |
| linked_state | `idle / ready / candidate / future_gate / blocked` as applicable |
| linked_visual_asset | `U4:raw-inbox` pending external refresh |
| license | ScoutFlow-original candidate geometry; no third-party art copied |
| format | Inline SVG concept, scalable |
...
### ILL13 Illustration Spec — bridge-preview / raw-inbox — audit expansion 1
...
本节适用于 `ILL13 Illustration Spec — bridge-preview / raw-inbox`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### ILL13 Illustration Spec — bridge-preview / raw-inbox — audit expansion 2
...
### ILL13 Illustration Spec — bridge-preview / raw-inbox — audit expansion 3
...
### ILL13 Illustration Spec — bridge-preview / raw-inbox — audit expansion 4
...
### ILL13 Illustration Spec — bridge-preview / raw-inbox — audit expansion 5
...
### ILL13 Illustration Spec — bridge-preview / raw-inbox — audit expansion 6
