---
title: "ILL14 Illustration Spec — audit-room / mobile-stack"
...
# ILL14 Illustration Spec — audit-room / mobile-stack
...
## Illustration `audit-room`

| Field | Value |
|---|---|
| illustration_id | `audit-room` |
| intent | Audit room |
| concept | human-in-loop gate |
| linked_state | `idle / ready / candidate / future_gate / blocked` as applicable |
| linked_visual_asset | `U4:audit-room` pending external refresh |
...
## Illustration `mobile-stack`

| Field | Value |
|---|---|
| illustration_id | `mobile-stack` |
| intent | Mobile stack |
| concept | linear four panel safe-area |
| linked_state | `idle / ready / candidate / future_gate / blocked` as applicable |
| linked_visual_asset | `U4:mobile-stack` pending external refresh |
| license | ScoutFlow-original candidate geometry; no third-party art copied |
| format | Inline SVG concept, scalable |
...
### ILL14 Illustration Spec — audit-room / mobile-stack — audit expansion 1
...
本节适用于 `ILL14 Illustration Spec — audit-room / mobile-stack`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### ILL14 Illustration Spec — audit-room / mobile-stack — audit expansion 2
...
### ILL14 Illustration Spec — audit-room / mobile-stack — audit expansion 3
...
### ILL14 Illustration Spec — audit-room / mobile-stack — audit expansion 4
...
### ILL14 Illustration Spec — audit-room / mobile-stack — audit expansion 5
