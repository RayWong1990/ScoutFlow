---
title: "ILL15 Illustration Spec — template-system / deep-sea-grid"
...
# ILL15 Illustration Spec — template-system / deep-sea-grid
...
## Illustration `template-system`

| Field | Value |
|---|---|
| illustration_id | `template-system` |
| intent | Template system |
| concept | PPT/poster/H5 reuse |
| linked_state | `idle / ready / candidate / future_gate / blocked` as applicable |
| linked_visual_asset | `U4:template-system` pending external refresh |
...
## Illustration `deep-sea-grid`

| Field | Value |
|---|---|
| illustration_id | `deep-sea-grid` |
| intent | Deep sea grid |
| concept | brand background foundation |
| linked_state | `idle / ready / candidate / future_gate / blocked` as applicable |
| linked_visual_asset | `U4:deep-sea-grid` pending external refresh |
| license | ScoutFlow-original candidate geometry; no third-party art copied |
| format | Inline SVG concept, scalable |
...
### ILL15 Illustration Spec — template-system / deep-sea-grid — audit expansion 1
...
本节适用于 `ILL15 Illustration Spec — template-system / deep-sea-grid`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### ILL15 Illustration Spec — template-system / deep-sea-grid — audit expansion 2
...
### ILL15 Illustration Spec — template-system / deep-sea-grid — audit expansion 3
...
### ILL15 Illustration Spec — template-system / deep-sea-grid — audit expansion 4
...
### ILL15 Illustration Spec — template-system / deep-sea-grid — audit expansion 5
...
### ILL15 Illustration Spec — template-system / deep-sea-grid — audit expansion 6
