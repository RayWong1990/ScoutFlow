---
title: "PAT01 Pattern Spec — deep-grid / proof-dots"
...
# PAT01 Pattern Spec — deep-grid / proof-dots
...
| Field | Value |
|---|---|
| pattern_id | `deep-grid` |
| intent | subtle 8dp background grid |
| recommended_use | canvas background |
...
| Field | Value |
|---|---|
| pattern_id | `proof-dots` |
| intent | small evidence dots |
| recommended_use | Trust Trace quiet background |
| token_refs | `sf.canvas.0`, `sf.border.panel`, `sf.accent.cyan` with opacity <= .45 |
| license | ScoutFlow-original candidate geometry |
| asset_type | inline SVG pattern concept |
...
### PAT01 Pattern Spec — deep-grid / proof-dots — audit expansion 1
...
本节适用于 `PAT01 Pattern Spec — deep-grid / proof-dots`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### PAT01 Pattern Spec — deep-grid / proof-dots — audit expansion 2
...
### PAT01 Pattern Spec — deep-grid / proof-dots — audit expansion 3
...
### PAT01 Pattern Spec — deep-grid / proof-dots — audit expansion 4
...
### PAT01 Pattern Spec — deep-grid / proof-dots — audit expansion 5
...
### PAT01 Pattern Spec — deep-grid / proof-dots — audit expansion 6
