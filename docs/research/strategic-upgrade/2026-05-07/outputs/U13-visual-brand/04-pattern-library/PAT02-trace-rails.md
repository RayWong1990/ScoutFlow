---
title: "PAT02 Pattern Spec — trace-rails / divider-rhythm"
...
# PAT02 Pattern Spec — trace-rails / divider-rhythm
...
| Field | Value |
|---|---|
| pattern_id | `trace-rails` |
| intent | dependency rail lines |
| recommended_use | graph/phase diagrams |
...
## Pattern `divider-rhythm`

| Field | Value |
|---|---|
| pattern_id | `divider-rhythm` |
| intent | section divider |
| recommended_use | PPT/poster/H5 dividers |
| token_refs | `sf.canvas.0`, `sf.border.panel`, `sf.accent.cyan` with opacity <= .45 |
| license | ScoutFlow-original candidate geometry |
| asset_type | inline SVG pattern concept |
...
### PAT02 Pattern Spec — trace-rails / divider-rhythm — audit expansion 1
...
本节适用于 `PAT02 Pattern Spec — trace-rails / divider-rhythm`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### PAT02 Pattern Spec — trace-rails / divider-rhythm — audit expansion 2
...
### PAT02 Pattern Spec — trace-rails / divider-rhythm — audit expansion 3
...
### PAT02 Pattern Spec — trace-rails / divider-rhythm — audit expansion 4
...
### PAT02 Pattern Spec — trace-rails / divider-rhythm — audit expansion 5
...
### PAT02 Pattern Spec — trace-rails / divider-rhythm — audit expansion 6
