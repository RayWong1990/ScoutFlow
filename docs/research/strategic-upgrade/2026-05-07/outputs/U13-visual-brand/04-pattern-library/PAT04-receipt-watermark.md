---
title: "PAT04 Pattern Spec — receipt-watermark / safe-area-mask"
...
# PAT04 Pattern Spec — receipt-watermark / safe-area-mask
...
## Pattern `receipt-watermark`

| Field | Value |
|---|---|
| pattern_id | `receipt-watermark` |
| intent | ledger line watermark |
| recommended_use | receipt/audit templates |
...
## Pattern `safe-area-mask`

| Field | Value |
|---|---|
| pattern_id | `safe-area-mask` |
| intent | mobile safe-area frame |
| recommended_use | H5/mobile template |
| token_refs | `sf.canvas.0`, `sf.border.panel`, `sf.accent.cyan` with opacity <= .45 |
| license | ScoutFlow-original candidate geometry |
| asset_type | inline SVG pattern concept |
...
### PAT04 Pattern Spec — receipt-watermark / safe-area-mask — audit expansion 1
...
本节适用于 `PAT04 Pattern Spec — receipt-watermark / safe-area-mask`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### PAT04 Pattern Spec — receipt-watermark / safe-area-mask — audit expansion 2
...
### PAT04 Pattern Spec — receipt-watermark / safe-area-mask — audit expansion 3
...
### PAT04 Pattern Spec — receipt-watermark / safe-area-mask — audit expansion 4
...
### PAT04 Pattern Spec — receipt-watermark / safe-area-mask — audit expansion 5
...
### PAT04 Pattern Spec — receipt-watermark / safe-area-mask — audit expansion 6
