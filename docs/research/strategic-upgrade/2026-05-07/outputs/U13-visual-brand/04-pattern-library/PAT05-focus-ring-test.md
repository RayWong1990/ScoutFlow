---
title: "PAT05 Pattern Spec — focus-ring-test / scope-stripes"
...
# PAT05 Pattern Spec — focus-ring-test / scope-stripes
...
## Pattern `focus-ring-test`

| Field | Value |
|---|---|
| pattern_id | `focus-ring-test` |
| intent | focus ring demonstration |
| recommended_use | accessibility review |
...
## Pattern `scope-stripes`

| Field | Value |
|---|---|
| pattern_id | `scope-stripes` |
| intent | blocked/future lane stripe |
| recommended_use | state panels |
| token_refs | `sf.canvas.0`, `sf.border.panel`, `sf.accent.cyan` with opacity <= .45 |
| license | ScoutFlow-original candidate geometry |
| asset_type | inline SVG pattern concept |
...
### PAT05 Pattern Spec — focus-ring-test / scope-stripes — audit expansion 1
...
本节适用于 `PAT05 Pattern Spec — focus-ring-test / scope-stripes`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### PAT05 Pattern Spec — focus-ring-test / scope-stripes — audit expansion 2
...
### PAT05 Pattern Spec — focus-ring-test / scope-stripes — audit expansion 3
...
### PAT05 Pattern Spec — focus-ring-test / scope-stripes — audit expansion 4
...
### PAT05 Pattern Spec — focus-ring-test / scope-stripes — audit expansion 5
...
### PAT05 Pattern Spec — focus-ring-test / scope-stripes — audit expansion 6
