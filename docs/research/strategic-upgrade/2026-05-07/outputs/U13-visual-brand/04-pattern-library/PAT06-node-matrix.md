---
title: "PAT06 Pattern Spec — node-matrix / blueprint-crosshair"
...
# PAT06 Pattern Spec — node-matrix / blueprint-crosshair
...
| Field | Value |
|---|---|
| pattern_id | `node-matrix` |
| intent | node matrix background |
| recommended_use | Trust Trace export |
...
## Pattern `blueprint-crosshair`

| Field | Value |
|---|---|
| pattern_id | `blueprint-crosshair` |
| intent | measurement crosshair |
| recommended_use | spec sheet |
| token_refs | `sf.canvas.0`, `sf.border.panel`, `sf.accent.cyan` with opacity <= .45 |
| license | ScoutFlow-original candidate geometry |
| asset_type | inline SVG pattern concept |
...
### PAT06 Pattern Spec — node-matrix / blueprint-crosshair — audit expansion 1
...
本节适用于 `PAT06 Pattern Spec — node-matrix / blueprint-crosshair`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### PAT06 Pattern Spec — node-matrix / blueprint-crosshair — audit expansion 2
...
### PAT06 Pattern Spec — node-matrix / blueprint-crosshair — audit expansion 3
...
### PAT06 Pattern Spec — node-matrix / blueprint-crosshair — audit expansion 4
...
### PAT06 Pattern Spec — node-matrix / blueprint-crosshair — audit expansion 5
...
### PAT06 Pattern Spec — node-matrix / blueprint-crosshair — audit expansion 6
