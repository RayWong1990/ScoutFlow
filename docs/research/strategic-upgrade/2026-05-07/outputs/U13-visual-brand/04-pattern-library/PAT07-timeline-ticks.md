---
title: "PAT07 Pattern Spec — timeline-ticks / card-shelf-lines"
...
# PAT07 Pattern Spec — timeline-ticks / card-shelf-lines
...
## Pattern `timeline-ticks`

| Field | Value |
|---|---|
| pattern_id | `timeline-ticks` |
| intent | phase timeline ticks |
| recommended_use | evolution map |
...
## Pattern `card-shelf-lines`

| Field | Value |
|---|---|
| pattern_id | `card-shelf-lines` |
| intent | topic-card shelf |
| recommended_use | preview/vault |
| token_refs | `sf.canvas.0`, `sf.border.panel`, `sf.accent.cyan` with opacity <= .45 |
| license | ScoutFlow-original candidate geometry |
| asset_type | inline SVG pattern concept |
...
### PAT07 Pattern Spec — timeline-ticks / card-shelf-lines — audit expansion 1
...
本节适用于 `PAT07 Pattern Spec — timeline-ticks / card-shelf-lines`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### PAT07 Pattern Spec — timeline-ticks / card-shelf-lines — audit expansion 2
...
### PAT07 Pattern Spec — timeline-ticks / card-shelf-lines — audit expansion 3
...
### PAT07 Pattern Spec — timeline-ticks / card-shelf-lines — audit expansion 4
...
### PAT07 Pattern Spec — timeline-ticks / card-shelf-lines — audit expansion 5
