---
title: "PAT09 Pattern Spec — social-crop-guide / ppt-column-grid"
...
# PAT09 Pattern Spec — social-crop-guide / ppt-column-grid
...
## Pattern `social-crop-guide`

| Field | Value |
|---|---|
| pattern_id | `social-crop-guide` |
| intent | crop-safe guide |
| recommended_use | social card |
...
<svg viewBox="0 0 160 96" role="img" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M0 8H160 M0 16H160 M0 24H160 M0 32H160 M8 0V96 M16 0V96 M24 0V96 M32 0V96 M40 0V96" stroke="#27415D" stroke-opacity=".45"/>
...
## Pattern `ppt-column-grid`

| Field | Value |
|---|---|
| pattern_id | `ppt-column-grid` |
| intent | presentation columns |
| recommended_use | slides |
| token_refs | `sf.canvas.0`, `sf.border.panel`, `sf.accent.cyan` with opacity <= .45 |
| license | ScoutFlow-original candidate geometry |
| asset_type | inline SVG pattern concept |
...
<svg viewBox="0 0 160 96" role="img" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
  <path d="M0 0H160V96H0Z" fill="#07111B"/>
  <path d="M0 12H160 M0 24H160 M0 36H160 M0 48H160 M12 0V96 M24 0V96 M36 0V96 M48 0V96 M60 0V96" stroke="#27415D" stroke-opacity=".45"/>
  <path d="M16 72C40 40 64 40 88 72C112 104 136 104 152 72" stroke="#50D4FF" stroke-opacity=".35" stroke-width="2" fill="none"/>
</svg>
```
...
### PAT09 Pattern Spec — social-crop-guide / ppt-column-grid — audit expansion 1
...
本节适用于 `PAT09 Pattern Spec — social-crop-guide / ppt-column-grid`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### PAT09 Pattern Spec — social-crop-guide / ppt-column-grid — audit expansion 2
...
### PAT09 Pattern Spec — social-crop-guide / ppt-column-grid — audit expansion 3
...
### PAT09 Pattern Spec — social-crop-guide / ppt-column-grid — audit expansion 4
...
### PAT09 Pattern Spec — social-crop-guide / ppt-column-grid — audit expansion 5
...
### PAT09 Pattern Spec — social-crop-guide / ppt-column-grid — audit expansion 6
