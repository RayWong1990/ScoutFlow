---
title: "PAT10 Pattern Spec — h5-density-grid / license-shield-pattern"
...
# PAT10 Pattern Spec — h5-density-grid / license-shield-pattern
...
## Pattern `h5-density-grid`

| Field | Value |
|---|---|
| pattern_id | `h5-density-grid` |
| intent | responsive density grid |
| recommended_use | H5 |
...
## Pattern `license-shield-pattern`

| Field | Value |
|---|---|
| pattern_id | `license-shield-pattern` |
| intent | license/audit stamp |
| recommended_use | supporting docs |
| token_refs | `sf.canvas.0`, `sf.border.panel`, `sf.accent.cyan` with opacity <= .45 |
| license | ScoutFlow-original candidate geometry |
| asset_type | inline SVG pattern concept |
...
### PAT10 Pattern Spec — h5-density-grid / license-shield-pattern — audit expansion 1
...
本节适用于 `PAT10 Pattern Spec — h5-density-grid / license-shield-pattern`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### PAT10 Pattern Spec — h5-density-grid / license-shield-pattern — audit expansion 2
...
### PAT10 Pattern Spec — h5-density-grid / license-shield-pattern — audit expansion 3
...
### PAT10 Pattern Spec — h5-density-grid / license-shield-pattern — audit expansion 4
...
### PAT10 Pattern Spec — h5-density-grid / license-shield-pattern — audit expansion 5
...
### PAT10 Pattern Spec — h5-density-grid / license-shield-pattern — audit expansion 6
