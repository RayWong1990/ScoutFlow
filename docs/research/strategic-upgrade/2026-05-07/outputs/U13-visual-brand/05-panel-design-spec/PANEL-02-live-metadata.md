---
title: PANEL-02 Live Metadata Design Spec
...
# PANEL-02 Live Metadata Design Spec

## Mission

`Live Metadata` is one of the atlas-level panel specs for ScoutFlow's strong visual capture station. It translates the local packet's four-panel H5 direction into reusable visual, state, accessibility and audit instructions.

## Functional summary

title/uploader/duration/page count/probe provenance
...
Linked U7 states: `empty, loading, ready, stale, probe_failed`. U7 external source refresh was unavailable in this environment, so the mapping is a candidate bridge based on local post176 state language.
...
```text
machine values settle without fake data.
```
...
### PANEL-02 Live Metadata Design Spec — audit expansion 1
...
本节适用于 `PANEL-02 Live Metadata Design Spec`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### PANEL-02 Live Metadata Design Spec — audit expansion 2
...
### PANEL-02 Live Metadata Design Spec — audit expansion 3
...
### PANEL-02 Live Metadata Design Spec — audit expansion 4
...
### PANEL-02 Live Metadata Design Spec — audit expansion 5
...
### PANEL-02 Live Metadata Design Spec — audit expansion 6
...
### PANEL-02 Live Metadata Design Spec — audit expansion 7
...
### PANEL-02 Live Metadata Design Spec — audit expansion 8
...
### PANEL-02 Live Metadata Design Spec — audit expansion 9
...
### PANEL-02 Live Metadata Design Spec — audit expansion 10
...
### PANEL-02 Live Metadata Design Spec — audit expansion 11
...
### PANEL-02 Live Metadata Design Spec — audit expansion 12
