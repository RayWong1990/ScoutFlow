---
title: PANEL-05 Topic Card Preview Design Spec
...
# PANEL-05 Topic Card Preview Design Spec

## Mission

`Topic Card Preview` is one of the atlas-level panel specs for ScoutFlow's strong visual capture station. It translates the local packet's four-panel H5 direction into reusable visual, state, accessibility and audit instructions.

## Functional summary

preview-only topic/evidence card before vault write
...
Linked U7 states: `candidate, preview_only, stale, blocked`. U7 external source refresh was unavailable in this environment, so the mapping is a candidate bridge based on local post176 state language.
...
```text
preview surface does not imply authority write.
```
...
### PANEL-05 Topic Card Preview Design Spec — audit expansion 1
...
本节适用于 `PANEL-05 Topic Card Preview Design Spec`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### PANEL-05 Topic Card Preview Design Spec — audit expansion 2
...
### PANEL-05 Topic Card Preview Design Spec — audit expansion 3
...
### PANEL-05 Topic Card Preview Design Spec — audit expansion 4
...
### PANEL-05 Topic Card Preview Design Spec — audit expansion 5
...
### PANEL-05 Topic Card Preview Design Spec — audit expansion 6
...
### PANEL-05 Topic Card Preview Design Spec — audit expansion 7
...
### PANEL-05 Topic Card Preview Design Spec — audit expansion 8
...
### PANEL-05 Topic Card Preview Design Spec — audit expansion 9
...
### PANEL-05 Topic Card Preview Design Spec — audit expansion 10
...
### PANEL-05 Topic Card Preview Design Spec — audit expansion 11
