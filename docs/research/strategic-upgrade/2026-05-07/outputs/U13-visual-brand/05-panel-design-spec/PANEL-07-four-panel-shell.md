---
title: PANEL-07 Four Panel Shell Design Spec
...
# PANEL-07 Four Panel Shell Design Spec

## Mission

`Four Panel Shell` is one of the atlas-level panel specs for ScoutFlow's strong visual capture station. It translates the local packet's four-panel H5 direction into reusable visual, state, accessibility and audit instructions.

## Functional summary

desktop/tablet/mobile grid orchestration
...
Linked U7 states: `idle, dense, compact, review`. U7 external source refresh was unavailable in this environment, so the mapping is a candidate bridge based on local post176 state language.
...
```text
URL->Metadata->Scope->Trace order preserved.
```
...
### PANEL-07 Four Panel Shell Design Spec — audit expansion 1
...
本节适用于 `PANEL-07 Four Panel Shell Design Spec`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### PANEL-07 Four Panel Shell Design Spec — audit expansion 2
...
### PANEL-07 Four Panel Shell Design Spec — audit expansion 3
...
### PANEL-07 Four Panel Shell Design Spec — audit expansion 4
...
### PANEL-07 Four Panel Shell Design Spec — audit expansion 5
...
### PANEL-07 Four Panel Shell Design Spec — audit expansion 6
...
### PANEL-07 Four Panel Shell Design Spec — audit expansion 7
...
### PANEL-07 Four Panel Shell Design Spec — audit expansion 8
...
### PANEL-07 Four Panel Shell Design Spec — audit expansion 9
...
### PANEL-07 Four Panel Shell Design Spec — audit expansion 10
...
### PANEL-07 Four Panel Shell Design Spec — audit expansion 11
...
### PANEL-07 Four Panel Shell Design Spec — audit expansion 12
