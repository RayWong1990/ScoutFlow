...
# TEMPLATE-01 PPT Cover

## Template mission

`PPT Cover` is a multi-medium brand surface for ScoutFlow. It must feel like the same evidence workstation whether exported as a slide, poster, social card or H5 view.

| Field | Value |
|---|---|
| template_id | `ppt-cover` |
| canvas / size | 16:9 1920x1080 |
| primary slots | station title, phase label, evidence subtitle, quiet deep grid |
| linked_visual_asset | `U4:ppt-cover` pending external refresh |
...
### TEMPLATE-01 PPT Cover — audit expansion 1
...
本节适用于 `TEMPLATE-01 PPT Cover`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### TEMPLATE-01 PPT Cover — audit expansion 2
...
### TEMPLATE-01 PPT Cover — audit expansion 3
...
### TEMPLATE-01 PPT Cover — audit expansion 4
...
### TEMPLATE-01 PPT Cover — audit expansion 5
...
### TEMPLATE-01 PPT Cover — audit expansion 6
...
### TEMPLATE-01 PPT Cover — audit expansion 7
...
### TEMPLATE-01 PPT Cover — audit expansion 8
...
### TEMPLATE-01 PPT Cover — audit expansion 9
