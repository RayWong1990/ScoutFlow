---
title: TEMPLATE-02 PPT Section Divider
...
# TEMPLATE-02 PPT Section Divider

## Template mission

`PPT Section Divider` is a multi-medium brand surface for ScoutFlow. It must feel like the same evidence workstation whether exported as a slide, poster, social card or H5 view.

| Field | Value |
|---|---|
| template_id | `ppt-section` |
| canvas / size | 16:9 1920x1080 |
| primary slots | section title, node chain, phase badge |
| linked_visual_asset | `U4:ppt-section` pending external refresh |
...
### TEMPLATE-02 PPT Section Divider — audit expansion 1
...
本节适用于 `TEMPLATE-02 PPT Section Divider`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### TEMPLATE-02 PPT Section Divider — audit expansion 2
...
### TEMPLATE-02 PPT Section Divider — audit expansion 3
...
### TEMPLATE-02 PPT Section Divider — audit expansion 4
...
### TEMPLATE-02 PPT Section Divider — audit expansion 5
...
### TEMPLATE-02 PPT Section Divider — audit expansion 6
...
### TEMPLATE-02 PPT Section Divider — audit expansion 7
...
### TEMPLATE-02 PPT Section Divider — audit expansion 8
...
### TEMPLATE-02 PPT Section Divider — audit expansion 9
