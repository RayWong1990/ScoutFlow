---
title: TEMPLATE-03 PPT Comparison
...
# TEMPLATE-03 PPT Comparison

## Template mission

`PPT Comparison` is a multi-medium brand surface for ScoutFlow. It must feel like the same evidence workstation whether exported as a slide, poster, social card or H5 view.

| Field | Value |
|---|---|
| template_id | `ppt-comparison` |
| canvas / size | 16:9 1920x1080 |
| primary slots | good vs bad, gate verdict, evidence callout |
| linked_visual_asset | `U4:ppt-comparison` pending external refresh |
...
### TEMPLATE-03 PPT Comparison — audit expansion 1
...
本节适用于 `TEMPLATE-03 PPT Comparison`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### TEMPLATE-03 PPT Comparison — audit expansion 2
...
### TEMPLATE-03 PPT Comparison — audit expansion 3
...
### TEMPLATE-03 PPT Comparison — audit expansion 4
...
### TEMPLATE-03 PPT Comparison — audit expansion 5
...
### TEMPLATE-03 PPT Comparison — audit expansion 6
...
### TEMPLATE-03 PPT Comparison — audit expansion 7
...
### TEMPLATE-03 PPT Comparison — audit expansion 8
...
### TEMPLATE-03 PPT Comparison — audit expansion 9
