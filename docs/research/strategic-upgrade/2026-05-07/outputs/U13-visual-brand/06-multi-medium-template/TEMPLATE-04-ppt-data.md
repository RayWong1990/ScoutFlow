---
title: "TEMPLATE-04 PPT Data / Audit Table"
...
# TEMPLATE-04 PPT Data / Audit Table

## Template mission

`PPT Data / Audit Table` is a multi-medium brand surface for ScoutFlow. It must feel like the same evidence workstation whether exported as a slide, poster, social card or H5 view.

| Field | Value |
|---|---|
| template_id | `ppt-data` |
| canvas / size | 16:9 1920x1080 |
| primary slots | dense table, badge grammar, provenance column |
| linked_visual_asset | `U4:ppt-data` pending external refresh |
...
### TEMPLATE-04 PPT Data / Audit Table — audit expansion 1
...
本节适用于 `TEMPLATE-04 PPT Data / Audit Table`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### TEMPLATE-04 PPT Data / Audit Table — audit expansion 2
...
### TEMPLATE-04 PPT Data / Audit Table — audit expansion 3
...
### TEMPLATE-04 PPT Data / Audit Table — audit expansion 4
...
### TEMPLATE-04 PPT Data / Audit Table — audit expansion 5
...
### TEMPLATE-04 PPT Data / Audit Table — audit expansion 6
...
### TEMPLATE-04 PPT Data / Audit Table — audit expansion 7
...
### TEMPLATE-04 PPT Data / Audit Table — audit expansion 8
...
### TEMPLATE-04 PPT Data / Audit Table — audit expansion 9
