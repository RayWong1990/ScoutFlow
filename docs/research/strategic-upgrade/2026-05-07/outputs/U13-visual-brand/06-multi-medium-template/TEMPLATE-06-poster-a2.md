---
title: TEMPLATE-06 Poster A2 Portrait
...
# TEMPLATE-06 Poster A2 Portrait

## Template mission

`Poster A2 Portrait` is a multi-medium brand surface for ScoutFlow. It must feel like the same evidence workstation whether exported as a slide, poster, social card or H5 view.

| Field | Value |
|---|---|
| template_id | `poster-a2` |
| canvas / size | 420x594mm |
| primary slots | hero illustration, four-panel map, concise gate copy |
| linked_visual_asset | `U4:poster-a2` pending external refresh |
...
### TEMPLATE-06 Poster A2 Portrait — audit expansion 1
...
本节适用于 `TEMPLATE-06 Poster A2 Portrait`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### TEMPLATE-06 Poster A2 Portrait — audit expansion 2
...
### TEMPLATE-06 Poster A2 Portrait — audit expansion 3
...
### TEMPLATE-06 Poster A2 Portrait — audit expansion 4
...
### TEMPLATE-06 Poster A2 Portrait — audit expansion 5
...
### TEMPLATE-06 Poster A2 Portrait — audit expansion 6
...
### TEMPLATE-06 Poster A2 Portrait — audit expansion 7
...
### TEMPLATE-06 Poster A2 Portrait — audit expansion 8
...
### TEMPLATE-06 Poster A2 Portrait — audit expansion 9
