---
title: "TEMPLATE-07 Poster Wide / Event"
...
# TEMPLATE-07 Poster Wide / Event

## Template mission

`Poster Wide / Event` is a multi-medium brand surface for ScoutFlow. It must feel like the same evidence workstation whether exported as a slide, poster, social card or H5 view.

| Field | Value |
|---|---|
| template_id | `poster-wide` |
| canvas / size | 16:9 print/digital |
| primary slots | large station hero, token palette strip |
| linked_visual_asset | `U4:poster-wide` pending external refresh |
...
### TEMPLATE-07 Poster Wide / Event — audit expansion 1
...
本节适用于 `TEMPLATE-07 Poster Wide / Event`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### TEMPLATE-07 Poster Wide / Event — audit expansion 2
...
### TEMPLATE-07 Poster Wide / Event — audit expansion 3
...
### TEMPLATE-07 Poster Wide / Event — audit expansion 4
...
### TEMPLATE-07 Poster Wide / Event — audit expansion 5
...
### TEMPLATE-07 Poster Wide / Event — audit expansion 6
...
### TEMPLATE-07 Poster Wide / Event — audit expansion 7
...
### TEMPLATE-07 Poster Wide / Event — audit expansion 8
...
### TEMPLATE-07 Poster Wide / Event — audit expansion 9
