---
title: TEMPLATE-08 Poster Mobile Vertical
...
# TEMPLATE-08 Poster Mobile Vertical

## Template mission

`Poster Mobile Vertical` is a multi-medium brand surface for ScoutFlow. It must feel like the same evidence workstation whether exported as a slide, poster, social card or H5 view.

| Field | Value |
|---|---|
| template_id | `poster-mobile` |
| canvas / size | 1080x1920 |
| primary slots | mobile-safe crop with state cards |
| linked_visual_asset | `U4:poster-mobile` pending external refresh |
...
### TEMPLATE-08 Poster Mobile Vertical — audit expansion 1
...
本节适用于 `TEMPLATE-08 Poster Mobile Vertical`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### TEMPLATE-08 Poster Mobile Vertical — audit expansion 2
...
### TEMPLATE-08 Poster Mobile Vertical — audit expansion 3
...
### TEMPLATE-08 Poster Mobile Vertical — audit expansion 4
...
### TEMPLATE-08 Poster Mobile Vertical — audit expansion 5
...
### TEMPLATE-08 Poster Mobile Vertical — audit expansion 6
...
### TEMPLATE-08 Poster Mobile Vertical — audit expansion 7
...
### TEMPLATE-08 Poster Mobile Vertical — audit expansion 8
...
### TEMPLATE-08 Poster Mobile Vertical — audit expansion 9
