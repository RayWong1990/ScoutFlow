---
title: TEMPLATE-09 Social Card Multi Platform
...
# TEMPLATE-09 Social Card Multi Platform

## Template mission

`Social Card Multi Platform` is a multi-medium brand surface for ScoutFlow. It must feel like the same evidence workstation whether exported as a slide, poster, social card or H5 view.

| Field | Value |
|---|---|
| template_id | `social-card` |
| canvas / size | 1:1 / 16:9 / 9:16 |
| primary slots | portable quote, badge, evidence count |
| linked_visual_asset | `U4:social-card` pending external refresh |
...
### TEMPLATE-09 Social Card Multi Platform — audit expansion 1
...
本节适用于 `TEMPLATE-09 Social Card Multi Platform`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### TEMPLATE-09 Social Card Multi Platform — audit expansion 2
...
### TEMPLATE-09 Social Card Multi Platform — audit expansion 3
...
### TEMPLATE-09 Social Card Multi Platform — audit expansion 4
...
### TEMPLATE-09 Social Card Multi Platform — audit expansion 5
...
### TEMPLATE-09 Social Card Multi Platform — audit expansion 6
...
### TEMPLATE-09 Social Card Multi Platform — audit expansion 7
...
### TEMPLATE-09 Social Card Multi Platform — audit expansion 8
...
### TEMPLATE-09 Social Card Multi Platform — audit expansion 9
