---
title: GATE-01 Visual Hierarchy Test Cases
...
# GATE-01 Visual Hierarchy Test Cases

## Gate mission

URL/action/current state is recognized within 3 seconds. This file contains six good-vs-bad audit cases for the gate. Cases are deliberately reusable across app panels, PPT/poster/social templates and PF-V generated images.

| Case | Scenario | Good | Bad | Disposition |
|---|---|---|---|---|
| `G1-visual-hierarchy-case-01` | Visual Hierarchy scenario 1 | good keeps URL/action/current state is recognized within 3 seconds | bad violates gate through drift/overclaim | stop/repair if critical |
| `G1-visual-hierarchy-case-02` | Visual Hierarchy scenario 2 | good keeps URL/action/current state is recognized within 3 seconds | bad violates gate through drift/overclaim | stop/repair if critical |
| `G1-visual-hierarchy-case-03` | Visual Hierarchy scenario 3 | good keeps URL/action/current state is recognized within 3 seconds | bad violates gate through drift/overclaim | stop/repair if critical |
| `G1-visual-hierarchy-case-04` | Visual Hierarchy scenario 4 | good keeps URL/action/current state is recognized within 3 seconds | bad violates gate through drift/overclaim | stop/repair if critical |
| `G1-visual-hierarchy-case-05` | Visual Hierarchy scenario 5 | good keeps URL/action/current state is recognized within 3 seconds | bad violates gate through drift/overclaim | stop/repair if critical |
| `G1-visual-hierarchy-case-06` | Visual Hierarchy scenario 6 | good keeps URL/action/current state is recognized within 3 seconds | bad violates gate through drift/overclaim | stop/repair if critical |


### case_id: `G1-visual-hierarchy-case-01`

**Good**: The screen/template keeps `URL/action/current state is recognized within 3 seconds`. State copy is visible, token references are consistent, and the reviewer can explain why the object passes without relying on subjective taste.
...
### case_id: `G1-visual-hierarchy-case-02`
...
### case_id: `G1-visual-hierarchy-case-03`
...
### case_id: `G1-visual-hierarchy-case-04`
...
### case_id: `G1-visual-hierarchy-case-05`
...
### case_id: `G1-visual-hierarchy-case-06`
...
### GATE-01 Visual Hierarchy Test Cases — audit expansion 1
...
本节适用于 `GATE-01 Visual Hierarchy Test Cases`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### GATE-01 Visual Hierarchy Test Cases — audit expansion 2
...
### GATE-01 Visual Hierarchy Test Cases — audit expansion 3
...
### GATE-01 Visual Hierarchy Test Cases — audit expansion 4
...
### GATE-01 Visual Hierarchy Test Cases — audit expansion 5
...
### GATE-01 Visual Hierarchy Test Cases — audit expansion 6
...
### GATE-01 Visual Hierarchy Test Cases — audit expansion 7
...
### GATE-01 Visual Hierarchy Test Cases — audit expansion 8
...
### GATE-01 Visual Hierarchy Test Cases — audit expansion 9
...
### GATE-01 Visual Hierarchy Test Cases — audit expansion 10
...
### GATE-01 Visual Hierarchy Test Cases — audit expansion 11
...
### GATE-01 Visual Hierarchy Test Cases — audit expansion 12
...
### GATE-01 Visual Hierarchy Test Cases — audit expansion 13
