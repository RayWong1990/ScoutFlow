---
title: GATE-03 Occlusion Safety Test Cases
...
# GATE-03 Occlusion Safety Test Cases

## Gate mission

overlays never cover critical evidence/action. This file contains six good-vs-bad audit cases for the gate. Cases are deliberately reusable across app panels, PPT/poster/social templates and PF-V generated images.

| Case | Scenario | Good | Bad | Disposition |
|---|---|---|---|---|
| `G3-occlusion-safety-case-01` | Occlusion Safety scenario 1 | good keeps overlays never cover critical evidence/action | bad violates gate through drift/overclaim | stop/repair if critical |
| `G3-occlusion-safety-case-02` | Occlusion Safety scenario 2 | good keeps overlays never cover critical evidence/action | bad violates gate through drift/overclaim | stop/repair if critical |
| `G3-occlusion-safety-case-03` | Occlusion Safety scenario 3 | good keeps overlays never cover critical evidence/action | bad violates gate through drift/overclaim | stop/repair if critical |
| `G3-occlusion-safety-case-04` | Occlusion Safety scenario 4 | good keeps overlays never cover critical evidence/action | bad violates gate through drift/overclaim | stop/repair if critical |
| `G3-occlusion-safety-case-05` | Occlusion Safety scenario 5 | good keeps overlays never cover critical evidence/action | bad violates gate through drift/overclaim | stop/repair if critical |
| `G3-occlusion-safety-case-06` | Occlusion Safety scenario 6 | good keeps overlays never cover critical evidence/action | bad violates gate through drift/overclaim | stop/repair if critical |


### case_id: `G3-occlusion-safety-case-01`

**Good**: The screen/template keeps `overlays never cover critical evidence/action`. State copy is visible, token references are consistent, and the reviewer can explain why the object passes without relying on subjective taste.
...
### case_id: `G3-occlusion-safety-case-02`
...
### case_id: `G3-occlusion-safety-case-03`
...
### case_id: `G3-occlusion-safety-case-04`
...
### case_id: `G3-occlusion-safety-case-05`
...
### case_id: `G3-occlusion-safety-case-06`
...
### GATE-03 Occlusion Safety Test Cases — audit expansion 1
...
本节适用于 `GATE-03 Occlusion Safety Test Cases`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### GATE-03 Occlusion Safety Test Cases — audit expansion 2
...
### GATE-03 Occlusion Safety Test Cases — audit expansion 3
...
### GATE-03 Occlusion Safety Test Cases — audit expansion 4
...
### GATE-03 Occlusion Safety Test Cases — audit expansion 5
...
### GATE-03 Occlusion Safety Test Cases — audit expansion 6
...
### GATE-03 Occlusion Safety Test Cases — audit expansion 7
...
### GATE-03 Occlusion Safety Test Cases — audit expansion 8
...
### GATE-03 Occlusion Safety Test Cases — audit expansion 9
...
### GATE-03 Occlusion Safety Test Cases — audit expansion 10
...
### GATE-03 Occlusion Safety Test Cases — audit expansion 11
...
### GATE-03 Occlusion Safety Test Cases — audit expansion 12
...
### GATE-03 Occlusion Safety Test Cases — audit expansion 13
