---
title: GATE-04 Typography Readability Test Cases
...
# GATE-04 Typography Readability Test Cases

## Gate mission

mixed Chinese/English and machine strings remain readable. This file contains six good-vs-bad audit cases for the gate. Cases are deliberately reusable across app panels, PPT/poster/social templates and PF-V generated images.

| Case | Scenario | Good | Bad | Disposition |
|---|---|---|---|---|
| `G4-typography-readability-case-01` | Typography Readability scenario 1 | good keeps mixed Chinese/English and machine strings remain readable | bad violates gate through drift/overclaim | stop/repair if critical |
| `G4-typography-readability-case-02` | Typography Readability scenario 2 | good keeps mixed Chinese/English and machine strings remain readable | bad violates gate through drift/overclaim | stop/repair if critical |
| `G4-typography-readability-case-03` | Typography Readability scenario 3 | good keeps mixed Chinese/English and machine strings remain readable | bad violates gate through drift/overclaim | stop/repair if critical |
| `G4-typography-readability-case-04` | Typography Readability scenario 4 | good keeps mixed Chinese/English and machine strings remain readable | bad violates gate through drift/overclaim | stop/repair if critical |
| `G4-typography-readability-case-05` | Typography Readability scenario 5 | good keeps mixed Chinese/English and machine strings remain readable | bad violates gate through drift/overclaim | stop/repair if critical |
| `G4-typography-readability-case-06` | Typography Readability scenario 6 | good keeps mixed Chinese/English and machine strings remain readable | bad violates gate through drift/overclaim | stop/repair if critical |


### case_id: `G4-typography-readability-case-01`

**Good**: The screen/template keeps `mixed Chinese/English and machine strings remain readable`. State copy is visible, token references are consistent, and the reviewer can explain why the object passes without relying on subjective taste.
...
### case_id: `G4-typography-readability-case-02`
...
### case_id: `G4-typography-readability-case-03`
...
### case_id: `G4-typography-readability-case-04`
...
### case_id: `G4-typography-readability-case-05`
...
### case_id: `G4-typography-readability-case-06`
...
### GATE-04 Typography Readability Test Cases — audit expansion 1
...
本节适用于 `GATE-04 Typography Readability Test Cases`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### GATE-04 Typography Readability Test Cases — audit expansion 2
...
### GATE-04 Typography Readability Test Cases — audit expansion 3
...
### GATE-04 Typography Readability Test Cases — audit expansion 4
...
### GATE-04 Typography Readability Test Cases — audit expansion 5
...
### GATE-04 Typography Readability Test Cases — audit expansion 6
...
### GATE-04 Typography Readability Test Cases — audit expansion 7
...
### GATE-04 Typography Readability Test Cases — audit expansion 8
...
### GATE-04 Typography Readability Test Cases — audit expansion 9
...
### GATE-04 Typography Readability Test Cases — audit expansion 10
...
### GATE-04 Typography Readability Test Cases — audit expansion 11
...
### GATE-04 Typography Readability Test Cases — audit expansion 12
...
### GATE-04 Typography Readability Test Cases — audit expansion 13
