---
title: GATE-05 Visual Weight Test Cases
...
# GATE-05 Visual Weight Test Cases

## Gate mission

active/proven/current is heavier than candidate/blocked/decorative. This file contains six good-vs-bad audit cases for the gate. Cases are deliberately reusable across app panels, PPT/poster/social templates and PF-V generated images.

| Case | Scenario | Good | Bad | Disposition |
|---|---|---|---|---|
| `G5-visual-weight-case-01` | Visual Weight scenario 1 | good keeps active/proven/current is heavier than candidate/blocked/decorative | bad violates gate through drift/overclaim | stop/repair if critical |
| `G5-visual-weight-case-02` | Visual Weight scenario 2 | good keeps active/proven/current is heavier than candidate/blocked/decorative | bad violates gate through drift/overclaim | stop/repair if critical |
| `G5-visual-weight-case-03` | Visual Weight scenario 3 | good keeps active/proven/current is heavier than candidate/blocked/decorative | bad violates gate through drift/overclaim | stop/repair if critical |
| `G5-visual-weight-case-04` | Visual Weight scenario 4 | good keeps active/proven/current is heavier than candidate/blocked/decorative | bad violates gate through drift/overclaim | stop/repair if critical |
| `G5-visual-weight-case-05` | Visual Weight scenario 5 | good keeps active/proven/current is heavier than candidate/blocked/decorative | bad violates gate through drift/overclaim | stop/repair if critical |
| `G5-visual-weight-case-06` | Visual Weight scenario 6 | good keeps active/proven/current is heavier than candidate/blocked/decorative | bad violates gate through drift/overclaim | stop/repair if critical |


### case_id: `G5-visual-weight-case-01`

**Good**: The screen/template keeps `active/proven/current is heavier than candidate/blocked/decorative`. State copy is visible, token references are consistent, and the reviewer can explain why the object passes without relying on subjective taste.
...
### case_id: `G5-visual-weight-case-02`
...
### case_id: `G5-visual-weight-case-03`
...
### case_id: `G5-visual-weight-case-04`
...
### case_id: `G5-visual-weight-case-05`
...
### case_id: `G5-visual-weight-case-06`
...
### GATE-05 Visual Weight Test Cases — audit expansion 1
...
本节适用于 `GATE-05 Visual Weight Test Cases`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### GATE-05 Visual Weight Test Cases — audit expansion 2
...
### GATE-05 Visual Weight Test Cases — audit expansion 3
...
### GATE-05 Visual Weight Test Cases — audit expansion 4
...
### GATE-05 Visual Weight Test Cases — audit expansion 5
...
### GATE-05 Visual Weight Test Cases — audit expansion 6
...
### GATE-05 Visual Weight Test Cases — audit expansion 7
...
### GATE-05 Visual Weight Test Cases — audit expansion 8
...
### GATE-05 Visual Weight Test Cases — audit expansion 9
...
### GATE-05 Visual Weight Test Cases — audit expansion 10
...
### GATE-05 Visual Weight Test Cases — audit expansion 11
...
### GATE-05 Visual Weight Test Cases — audit expansion 12
...
### GATE-05 Visual Weight Test Cases — audit expansion 13
