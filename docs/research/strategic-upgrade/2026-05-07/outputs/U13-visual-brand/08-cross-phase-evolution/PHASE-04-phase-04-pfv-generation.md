---
title: PHASE-04 PF-V Generation
...
# PHASE-04 PF-V Generation

## Phase mission

GPT-Image-2 prompts consume atlas without re-reasoning every scene. This phase map is a candidate planning artifact, not a promotion of any authority document.
...
### PHASE-04 PF-V Generation — audit expansion 1
...
本节适用于 `PHASE-04 PF-V Generation`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### PHASE-04 PF-V Generation — audit expansion 2
...
### PHASE-04 PF-V Generation — audit expansion 3
...
### PHASE-04 PF-V Generation — audit expansion 4
...
### PHASE-04 PF-V Generation — audit expansion 5
...
### PHASE-04 PF-V Generation — audit expansion 6
...
### PHASE-04 PF-V Generation — audit expansion 7
...
### PHASE-04 PF-V Generation — audit expansion 8
...
### PHASE-04 PF-V Generation — audit expansion 9
...
### PHASE-04 PF-V Generation — audit expansion 10
