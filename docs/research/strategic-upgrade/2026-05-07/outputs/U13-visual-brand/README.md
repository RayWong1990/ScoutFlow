---
title: README — U13 Visual Style System & Brand Atlas
...
# README — U13 Visual Style System & Brand Atlas

## What this ZIP contains

This ZIP contains a docs-only candidate visual style system and brand atlas for ScoutFlow U13. It includes token specs, icon specs, illustration specs, pattern specs, H5 panel specs, PPT/poster/social/H5 templates, 5-Gate tests, phase maps, cluster indexes and support ledgers.

## How to use

1. Open `00-supporting/MASTER-BRAND-ATLAS.md`.
2. Use `09-cluster-index/CLUSTER-01-master-index.md` to navigate.
3. For PF-V prompts, pull token refs from `01-token-system`, asset IDs from `02`/`03`/`04`, and state links from `00-supporting/LINKED-ASSET-AND-STATE.md`.
4. For any generated screenshot/image/template, run `00-supporting/5-GATE-TEST-SUITE-MASTER.md` and the relevant gate case file.
5. Before implementation, resolve live-web/license and repo-local source limitations.

## Important limitation

The environment did not provide live web access, the full local ScoutFlow repo, or the referenced U4/U7 GitHub files. The ZIP therefore avoids claiming live license validation or production CSS extraction. It is intentionally candidate/not-authority.
...
### README — U13 Visual Style System & Brand Atlas — audit expansion 1
...
本节适用于 `README — U13 Visual Style System & Brand Atlas`：审查者应记录 source label、state word、token reference、layout slot、failure class、defer condition 与 human reviewer note。若证据缺失，写 `needs_evidence`，不得写 `passed by assumption`。


### README — U13 Visual Style System & Brand Atlas — audit expansion 2
...
### README — U13 Visual Style System & Brand Atlas — audit expansion 3
...
### README — U13 Visual Style System & Brand Atlas — audit expansion 4
...
### README — U13 Visual Style System & Brand Atlas — audit expansion 5
...
### README — U13 Visual Style System & Brand Atlas — audit expansion 6
...
### README — U13 Visual Style System & Brand Atlas — audit expansion 7
...
### README — U13 Visual Style System & Brand Atlas — audit expansion 8
...
### README — U13 Visual Style System & Brand Atlas — audit expansion 9
