---
title: "faster-whisper CTranslate2 Apple Silicon evaluation"
status: "candidate / not-authority"
authority: "not-authority"
recipe_id: "A03"
cluster: "A_ASR"
framework: "faster-whisper / CTranslate2"
model: "Whisper converted model"
min_chip: "M2"
...
# A03 — faster-whisper CTranslate2 Apple Silicon evaluation
...
[recipe-spec] Python ASR integration may be convenient, but Apple Silicon acceleration must be proved rather than assumed.

## Optimal local configuration

[recipe-spec] Install in an isolated environment, capture CTranslate2 compute types, compare against whisper.cpp on the same WAV files, and evaluate timestamp schema compatibility before using it as a ScoutFlow worker.
...
|---|---|---|
| device_report | paste-time measurement | no value included |
| wall_time | paste-time measurement | no value included |
| timestamp_schema | paste-time measurement | no value included |
| python_import_cost | paste-time measurement | no value included |
| peak_memory | paste-time measurement | no value included |
...
```bash
python probe_faster_whisper.py --input fixture.wav --json out.json
```
...
## Extended operating rationale — faster-whisper CTranslate2 Apple Silicon evaluation
