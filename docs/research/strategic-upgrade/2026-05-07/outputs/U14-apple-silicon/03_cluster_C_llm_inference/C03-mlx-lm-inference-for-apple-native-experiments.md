---
title: "mlx-lm inference for Apple-native experiments"
status: "candidate / not-authority"
authority: "not-authority"
recipe_id: "C03"
cluster: "C_LLM_INFERENCE"
framework: "MLX / mlx-lm"
model: "MLX-compatible local LLM"
min_chip: "M2"
...
# C03 — mlx-lm inference for Apple-native experiments
...
[recipe-spec] Apple-native MLX may offer useful local inference and conversion experiments.

## Optimal local configuration

[recipe-spec] Install MLX in an isolated environment, pin versions, compare against llama.cpp and Ollama on identical prompts, and use MLX only when conversion and model support are stable enough for the task.
...
| load_time | paste-time measurement | no value included |
...
```bash
python -m mlx_lm.generate --model model_path --prompt "summarize"
```
...
## Extended operating rationale — mlx-lm inference for Apple-native experiments
