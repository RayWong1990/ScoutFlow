---
title: "Vision framework face and text detection adapter"
status: "candidate / not-authority"
authority: "not-authority"
recipe_id: "D02"
cluster: "D_IMAGE_VISUAL"
framework: "Apple Vision framework / Swift"
model: "Vision OCR and face detectors"
min_chip: "M1"
...
# D02 — Vision framework face and text detection adapter
...
[recipe-spec] Native Vision can provide local OCR regions, face boxes, and annotations for DAM indexing.

## Optimal local configuration

[recipe-spec] Wrap Vision calls behind a Swift CLI that outputs JSONL. Store bounding boxes, confidence, OS version, detector revision, source hash, and crop provenance.
...
| ocr_region_count | paste-time measurement | no value included |
| confidence_distribution | paste-time measurement | no value included |
...
```bash
swift run VisionProbe --manifest images.jsonl --out vision.jsonl
```
...
## Extended operating rationale — Vision framework face and text detection adapter
