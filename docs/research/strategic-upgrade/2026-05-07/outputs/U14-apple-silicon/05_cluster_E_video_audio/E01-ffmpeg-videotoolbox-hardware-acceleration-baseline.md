---
title: "FFmpeg VideoToolbox hardware acceleration baseline"
status: "candidate / not-authority"
authority: "not-authority"
recipe_id: "E01"
cluster: "E_VIDEO_AUDIO"
framework: "FFmpeg + VideoToolbox"
model: "h264/hevc videotoolbox codecs"
min_chip: "M1"
...
# E01 — FFmpeg VideoToolbox hardware acceleration baseline
...
[recipe-spec] Hardware-assisted media preprocessing can accelerate videos before ASR or frame extraction.

## Optimal local configuration

[recipe-spec] Use VideoToolbox only when command output and quality review show it helps. Capture `ffmpeg -hwaccels`, codec availability, input probe, output probe, and checksum.
...
|---|---|---|
| transcode_speed | paste-time measurement | no value included |
| cpu_usage | paste-time measurement | no value included |
| codec_available | paste-time measurement | no value included |
| quality_review | paste-time measurement | no value included |
| output_size | paste-time measurement | no value included |
...
```bash
ffmpeg -i in.mov -c:v h264_videotoolbox -b:v TARGET out.mp4
```
...
## Extended operating rationale — FFmpeg VideoToolbox hardware acceleration baseline
