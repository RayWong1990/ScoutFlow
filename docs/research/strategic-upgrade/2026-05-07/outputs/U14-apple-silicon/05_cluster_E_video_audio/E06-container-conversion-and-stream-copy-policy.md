---
title: "Container conversion and stream-copy policy"
status: "candidate / not-authority"
authority: "not-authority"
recipe_id: "E06"
cluster: "E_VIDEO_AUDIO"
framework: "FFmpeg / AVFoundation"
model: "media containers"
min_chip: "M1"
...
# E06 — Container conversion and stream-copy policy
...
[recipe-spec] Container conversion should not accidentally become quality-damaging transcoding.

## Optimal local configuration

[recipe-spec] Prefer stream copy when codec is acceptable. Transcode only when downstream tools fail or proxy policy requires it. Capture before/after ffprobe metadata and keep originals immutable.
...
|---|---|---|
| conversion_time | paste-time measurement | no value included |
| quality_loss_review | paste-time measurement | no value included |
| output_size | paste-time measurement | no value included |
| stream_copy_success | paste-time measurement | no value included |
| downstream_success | paste-time measurement | no value included |
...
## Extended operating rationale — Container conversion and stream-copy policy
