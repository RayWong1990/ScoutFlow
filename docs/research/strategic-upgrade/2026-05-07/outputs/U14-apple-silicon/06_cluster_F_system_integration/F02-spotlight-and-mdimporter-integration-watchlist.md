---
title: "Spotlight and mdimporter integration watchlist"
status: "candidate / not-authority"
authority: "not-authority"
recipe_id: "F02"
cluster: "F_SYSTEM_INTEGRATION"
framework: "Spotlight / mdimporter"
model: "metadata importer"
min_chip: "M1"
...
# F02 — Spotlight and mdimporter integration watchlist
...
[recipe-spec] Finder search integration is convenient but should not become the system of record.

## Optimal local configuration

[recipe-spec] Prefer ScoutFlow sidecar metadata first. Consider mdimporter only after schema and privacy policy stabilize. Keep enough metadata in ScoutFlow indexes so Spotlight is optional.
...
|---|---|---|
| index_latency | paste-time measurement | no value included |
| metadata_visibility | paste-time measurement | no value included |
| privacy_review | paste-time measurement | no value included |
| rebuild_success | paste-time measurement | no value included |
| rollback_success | paste-time measurement | no value included |
...
```bash
mdimport -d2 sample.scoutflowmeta
```
...
- ScoutFlow search only
- xattr pointer
- Finder tags
- disable Spotlight integration
...
## Extended operating rationale — Spotlight and mdimporter integration watchlist
