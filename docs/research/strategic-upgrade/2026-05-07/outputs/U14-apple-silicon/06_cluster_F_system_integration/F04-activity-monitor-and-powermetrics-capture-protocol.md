---
title: "Activity Monitor and powermetrics capture protocol"
status: "candidate / not-authority"
authority: "not-authority"
recipe_id: "F04"
cluster: "F_SYSTEM_INTEGRATION"
framework: "Activity Monitor / powermetrics"
...
# F04 — Activity Monitor and powermetrics capture protocol
...
[recipe-spec] Optimization needs evidence for CPU, GPU, thermal, and memory behavior.

## Optimal local configuration

[recipe-spec] Use Activity Monitor for human inspection and powermetrics for short paste-time logs. Avoid automated sudo. Store telemetry with workload id and redact private paths.
...
|---|---|---|
| cpu_power | paste-time measurement | no value included |
| gpu_power | paste-time measurement | no value included |
| thermal_state | paste-time measurement | no value included |
| memory_pressure | paste-time measurement | no value included |
| process_memory | paste-time measurement | no value included |
...
```bash
sudo powermetrics --samplers smc,gpu_power,cpu_power -n 3
```
...
## Extended operating rationale — Activity Monitor and powermetrics capture protocol
