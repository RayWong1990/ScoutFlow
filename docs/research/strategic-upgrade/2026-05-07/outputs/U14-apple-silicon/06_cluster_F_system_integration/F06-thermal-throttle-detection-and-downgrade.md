---
title: "Thermal throttle detection and downgrade"
status: "candidate / not-authority"
authority: "not-authority"
recipe_id: "F06"
cluster: "F_SYSTEM_INTEGRATION"
framework: "powermetrics / scheduler guard"
model: "thermal state policy"
min_chip: "M2"
...
# F06 — Thermal throttle detection and downgrade
...
[recipe-spec] Sustained heat should downgrade work before corrupting throughput or user experience.

## Optimal local configuration

[recipe-spec] Monitor thermal warnings, lower throughput, swap growth, and UI jank. Downgrade by pausing new heavy jobs, shrinking models, or deferring video transcodes.
...
| throughput_drop | paste-time measurement | no value included |
| downgrade_count | paste-time measurement | no value included |
| job_success_rate | paste-time measurement | no value included |
| operator_interruptions | paste-time measurement | no value included |
...
```bash
python thermal_guard.py --sample WINDOW --policy downgrade
```
...
## Extended operating rationale — Thermal throttle detection and downgrade
