---
title: "GPU and ANE scheduling policy"
status: "candidate / not-authority"
authority: "not-authority"
recipe_id: "G02"
cluster: "G_RESOURCE_MANAGEMENT"
framework: "Metal / MPS / Core ML / ANE watchlist"
model: "accelerator-capable tasks"
min_chip: "M2"
...
# G02 — GPU and ANE scheduling policy
...
[recipe-spec] Different tasks may belong on GPU, ANE, media engines, or CPU, but backend claims need evidence.

## Optimal local configuration

[recipe-spec] Capture backend evidence for each job. Prefer proven Metal paths for llama.cpp/Whisper, Core ML or ANE for supported vision, VideoToolbox for codecs, and CPU for small deterministic transforms.
...
|---|---|---|
| backend_used | paste-time measurement | no value included |
...
| quality_match | paste-time measurement | no value included |
...
```bash
python backend_probe.py --job vision
```
...
## Extended operating rationale — GPU and ANE scheduling policy
