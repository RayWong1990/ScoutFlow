---
title: "ASR benchmark corpus and scoring protocol"
status: "candidate / not-authority"
authority: "not-authority"
recipe_id: "H02"
cluster: "H_BENCHMARKING_PROFILING"
framework: "ASR benchmark harness"
model: "Whisper / Parakeet / Voxtral candidates"
min_chip: "M1"
...
# H02 — ASR benchmark corpus and scoring protocol
...
[recipe-spec] ASR speed must be measured with representative private-like fixtures, not generic impressions.

## Optimal local configuration

[recipe-spec] Create a small curated corpus with human notes. Score real-time factor, timestamp drift, language handling, hallucination flags, diarization usefulness, and correction effort.
...
| manual_corrections | paste-time measurement | no value included |
...
```bash
python bench_asr.py --manifest audio_corpus.jsonl --models models.json
```

```bash
python score_asr_review.py transcripts/
```
...
## Extended operating rationale — ASR benchmark corpus and scoring protocol
