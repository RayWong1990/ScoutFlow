---
title: "Embedding retrieval benchmark protocol"
status: "candidate / not-authority"
authority: "not-authority"
recipe_id: "H03"
cluster: "H_BENCHMARKING_PROFILING"
framework: "retrieval benchmark harness"
model: "embedding and BM25 candidates"
min_chip: "M1"
...
# H03 — Embedding retrieval benchmark protocol
...
[recipe-spec] Retrieval optimization should be judged by whether the operator finds the right notes and assets.

## Optimal local configuration

[recipe-spec] Build query sets from real tasks: exact, semantic, bilingual, visual-DAM, stale-index, and entity queries. Measure recall by review, latency, index size, and rebuild cost.
...
| bilingual_success | paste-time measurement | no value included |
...
```bash
python bench_retrieval.py --queries queries.jsonl --index index.toml
```

```bash
python summarize_retrieval_results.py results.jsonl
```
...
## Extended operating rationale — Embedding retrieval benchmark protocol
