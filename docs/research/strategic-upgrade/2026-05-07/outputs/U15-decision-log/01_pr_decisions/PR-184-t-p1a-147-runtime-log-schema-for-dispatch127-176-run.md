---
decision_id: "PR-184-t-p1a-147-runtime-log-schema-for-dispatch127-176-run"
status: "candidate / decision-atlas / not-authority"
authority: "not-authority"
pr_number: 184
pr_exists_verified: true
merged: true
pr_url: "https://github.com/RayWong1990/ScoutFlow/pull/184"
pr_title: "T-P1A-147: Runtime-log schema for Dispatch127-176 run"
merged_at: "2026-05-05T17:51:40Z"
...
# PR #184 — T-P1A-147: Runtime-log schema for Dispatch127-176 run

## Evidence snapshot

| Field | Value |
|---|---|
| PR | [#184](https://github.com/RayWong1990/ScoutFlow/pull/184) |
| Merged at | `2026-05-05T17:51:40Z` |
| Cluster | `C01 Wave 5 Candidate Factory` |
...
Docs-only runtime-log schema for Dispatch127-176 run; provides structured logging vocabulary without runtime approval.
...
The chosen decision was to merge **T-P1A-147: Runtime-log schema for Dispatch127-176 run** as a contract item inside **C01 Wave 5 Candidate Factory**. The operational payload, as observed from the PR metadata/body summary, was: Docs-only runtime-log schema for Dispatch127-176 run; provides structured logging vocabulary without runtime approval.
...
The immediate outcome is a merged checkpoint in the PR ledger at `2026-05-05T17:51:40Z`. Downstream, this card should be read together with linked patterns `contract_first_evidence` and with the amend chain `{'amends': [], 'amended_by': [], 'related_prs': []}`. No U11 anti-pattern ID is attached because the U11 registry was not available in this build; inventing AP IDs would make the atlas less useful. The package therefore records a cross-link gap rather than pretending the registry was loaded.
