---
decision_id: "PR-185-t-p1a-148-run-summary-schema-for-dispatch127-176-run"
status: "candidate / decision-atlas / not-authority"
authority: "not-authority"
pr_number: 185
pr_exists_verified: true
merged: true
pr_url: "https://github.com/RayWong1990/ScoutFlow/pull/185"
pr_title: "T-P1A-148: RUN-SUMMARY schema for Dispatch127-176 run"
merged_at: "2026-05-05T17:53:05Z"
...
# PR #185 — T-P1A-148: RUN-SUMMARY schema for Dispatch127-176 run

## Evidence snapshot

| Field | Value |
|---|---|
| PR | [#185](https://github.com/RayWong1990/ScoutFlow/pull/185) |
| Merged at | `2026-05-05T17:53:05Z` |
| Cluster | `C01 Wave 5 Candidate Factory` |
...
Docs-only RUN-SUMMARY schema for Dispatch127-176 run; standardizes run summary shape for review and audit.
...
The chosen decision was to merge **T-P1A-148: RUN-SUMMARY schema for Dispatch127-176 run** as a contract item inside **C01 Wave 5 Candidate Factory**. The operational payload, as observed from the PR metadata/body summary, was: Docs-only RUN-SUMMARY schema for Dispatch127-176 run; standardizes run summary shape for review and audit.
...
The immediate outcome is a merged checkpoint in the PR ledger at `2026-05-05T17:53:05Z`. Downstream, this card should be read together with linked patterns `contract_first_evidence` and with the amend chain `{'amends': [], 'amended_by': [], 'related_prs': []}`. No U11 anti-pattern ID is attached because the U11 registry was not available in this build; inventing AP IDs would make the atlas less useful. The package therefore records a cross-link gap rather than pretending the registry was loaded.
