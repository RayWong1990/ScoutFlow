---
decision_id: "PR-186-t-p1a-149-product-lane-override-evidence-packet"
status: "candidate / decision-atlas / not-authority"
authority: "not-authority"
pr_number: 186
pr_exists_verified: true
merged: true
pr_url: "https://github.com/RayWong1990/ScoutFlow/pull/186"
pr_title: "T-P1A-149: Product-lane override evidence packet"
merged_at: "2026-05-05T17:54:30Z"
...
# PR #186 — T-P1A-149: Product-lane override evidence packet

## Evidence snapshot

| Field | Value |
|---|---|
| PR | [#186](https://github.com/RayWong1990/ScoutFlow/pull/186) |
| Merged at | `2026-05-05T17:54:30Z` |
| Cluster | `C01 Wave 5 Candidate Factory` |
| Decision kind | `other` |
...
Docs-only product-lane override evidence packet; captures evidence shape for controlled lane overrides.
...
The chosen decision was to merge **T-P1A-149: Product-lane override evidence packet** as a other item inside **C01 Wave 5 Candidate Factory**. The operational payload, as observed from the PR metadata/body summary, was: Docs-only product-lane override evidence packet; captures evidence shape for controlled lane overrides.
...
The immediate outcome is a merged checkpoint in the PR ledger at `2026-05-05T17:54:30Z`. Downstream, this card should be read together with linked patterns `evidence_receipt_readback` and with the amend chain `{'amends': [], 'amended_by': [], 'related_prs': []}`. No U11 anti-pattern ID is attached because the U11 registry was not available in this build; inventing AP IDs would make the atlas less useful. The package therefore records a cross-link gap rather than pretending the registry was loaded.
