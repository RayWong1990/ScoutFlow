---
decision_id: "PR-187-t-p1a-150-global-pool-staging-health-check-contract"
status: "candidate / decision-atlas / not-authority"
authority: "not-authority"
pr_number: 187
pr_exists_verified: true
merged: true
pr_url: "https://github.com/RayWong1990/ScoutFlow/pull/187"
pr_title: "T-P1A-150: Global pool staging health-check contract"
merged_at: "2026-05-05T17:55:55Z"
...
# PR #187 — T-P1A-150: Global pool staging health-check contract

## Evidence snapshot

| Field | Value |
|---|---|
| PR | [#187](https://github.com/RayWong1990/ScoutFlow/pull/187) |
| Merged at | `2026-05-05T17:55:55Z` |
| Cluster | `C01 Wave 5 Candidate Factory` |
...
Docs-only global pool staging health-check contract; defines candidate health check shape.
...
The chosen decision was to merge **T-P1A-150: Global pool staging health-check contract** as a contract item inside **C01 Wave 5 Candidate Factory**. The operational payload, as observed from the PR metadata/body summary, was: Docs-only global pool staging health-check contract; defines candidate health check shape.
...
The immediate outcome is a merged checkpoint in the PR ledger at `2026-05-05T17:55:55Z`. Downstream, this card should be read together with linked patterns `contract_first_evidence` and with the amend chain `{'amends': [], 'amended_by': [], 'related_prs': []}`. No U11 anti-pattern ID is attached because the U11 registry was not available in this build; inventing AP IDs would make the atlas less useful. The package therefore records a cross-link gap rather than pretending the registry was loaded.
