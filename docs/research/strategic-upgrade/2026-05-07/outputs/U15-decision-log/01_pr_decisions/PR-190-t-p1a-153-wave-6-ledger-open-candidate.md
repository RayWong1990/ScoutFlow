---
decision_id: "PR-190-t-p1a-153-wave-6-ledger-open-candidate"
status: "candidate / decision-atlas / not-authority"
authority: "not-authority"
pr_number: 190
pr_exists_verified: true
merged: true
pr_url: "https://github.com/RayWong1990/ScoutFlow/pull/190"
pr_title: "T-P1A-153: Wave 6 ledger-open candidate"
merged_at: "2026-05-05T18:08:50Z"
...
linked_patterns: ["candidate_not_authority_frontmatter", "preview_only_before_write", "system_of_record_split"]
linked_anti_patterns: []
canonical_decision_log_unchanged: true
---

# PR #190 — T-P1A-153: Wave 6 ledger-open candidate

## Evidence snapshot

| Field | Value |
|---|---|
| PR | [#190](https://github.com/RayWong1990/ScoutFlow/pull/190) |
| Merged at | `2026-05-05T18:08:50Z` |
| Cluster | `C02 Authority Sync / Wave Closeout` |
...
Authority-only Wave 6 candidate ledger-open writeback to current/task-index/decision-log; keeps state NOT_EXECUTION_APPROVED and opens candidate planning only.
...
The chosen decision was to merge **T-P1A-153: Wave 6 ledger-open candidate** as a authority-sync item inside **C02 Authority Sync / Wave Closeout**. The operational payload, as observed from the PR metadata/body summary, was: Authority-only Wave 6 candidate ledger-open writeback to current/task-index/decision-log; keeps state NOT_EXECUTION_APPROVED and opens candidate planning only.
...
The immediate outcome is a merged checkpoint in the PR ledger at `2026-05-05T18:08:50Z`. Downstream, this card should be read together with linked patterns `candidate_not_authority_frontmatter, preview_only_before_write, system_of_record_split` and with the amend chain `{'amends': [], 'amended_by': [], 'related_prs': []}`. No U11 anti-pattern ID is attached because the U11 registry was not available in this build; inventing AP IDs would make the atlas less useful. The package therefore records a cross-link gap rather than pretending the registry was loaded.
...
- Pattern files: `02_patterns/PATTERN-candidate_not_authority_frontmatter.md`, `02_patterns/PATTERN-preview_only_before_write.md`, `02_patterns/PATTERN-system_of_record_split.md`
