---
decision_id: "PR-193-docs-close-out-batch-abc-authority-sync"
status: "candidate / decision-atlas / not-authority"
authority: "not-authority"
pr_number: 193
pr_exists_verified: true
merged: true
pr_url: "https://github.com/RayWong1990/ScoutFlow/pull/193"
pr_title: "docs: close out batch abc authority sync"
merged_at: "2026-05-05T23:41:19Z"
...
# PR #193 — docs: close out batch abc authority sync

## Evidence snapshot

| Field | Value |
|---|---|
| PR | [#193](https://github.com/RayWong1990/ScoutFlow/pull/193) |
| Merged at | `2026-05-05T23:41:19Z` |
| Cluster | `C02 Authority Sync / Wave Closeout` |
...
Synced authority surfaces to landed Dispatch173-176 truth, recorded T-P1A-153/154/155 in task index, and clarified closure wording while keeping Wave 6 open without runtime approval.
...
The chosen decision was to merge **docs: close out batch abc authority sync** as a authority-sync item inside **C02 Authority Sync / Wave Closeout**. The operational payload, as observed from the PR metadata/body summary, was: Synced authority surfaces to landed Dispatch173-176 truth, recorded T-P1A-153/154/155 in task index, and clarified closure wording while keeping Wave 6 open without runtime approval.
...
The immediate outcome is a merged checkpoint in the PR ledger at `2026-05-05T23:41:19Z`. Downstream, this card should be read together with linked patterns `system_of_record_split` and with the amend chain `{'amends': [], 'amended_by': [], 'related_prs': []}`. No U11 anti-pattern ID is attached because the U11 registry was not available in this build; inventing AP IDs would make the atlas less useful. The package therefore records a cross-link gap rather than pretending the registry was loaded.
