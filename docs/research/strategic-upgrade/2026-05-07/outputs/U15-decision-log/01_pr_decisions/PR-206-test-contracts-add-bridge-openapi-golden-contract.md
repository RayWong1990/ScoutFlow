---
decision_id: "PR-206-test-contracts-add-bridge-openapi-golden-contract"
status: "candidate / decision-atlas / not-authority"
authority: "not-authority"
pr_number: 206
pr_exists_verified: true
merged: true
pr_url: "https://github.com/RayWong1990/ScoutFlow/pull/206"
pr_title: "test(contracts): add bridge openapi golden contract"
merged_at: "2026-05-06T09:24:43Z"
...
linked_patterns: ["contract_first_evidence"]
linked_anti_patterns: []
canonical_decision_log_unchanged: true
---

# PR #206 — test(contracts): add bridge openapi golden contract

## Evidence snapshot

| Field | Value |
|---|---|
| PR | [#206](https://github.com/RayWong1990/ScoutFlow/pull/206) |
| Merged at | `2026-05-06T09:24:43Z` |
| Cluster | `C04 PF-LP Run-1` |
...
Added PF-LP-13 golden contract coverage for mounted bridge OpenAPI paths and schema shapes, including minimal pytest --golden plumbing.
...
The chosen decision was to merge **test(contracts): add bridge openapi golden contract** as a contract item inside **C04 PF-LP Run-1**. The operational payload, as observed from the PR metadata/body summary, was: Added PF-LP-13 golden contract coverage for mounted bridge OpenAPI paths and schema shapes, including minimal pytest --golden plumbing.
...
The immediate outcome is a merged checkpoint in the PR ledger at `2026-05-06T09:24:43Z`. Downstream, this card should be read together with linked patterns `contract_first_evidence` and with the amend chain `{'amended_by': [231], 'related_prs': [231], 'amends': []}`. No U11 anti-pattern ID is attached because the U11 registry was not available in this build; inventing AP IDs would make the atlas less useful. The package therefore records a cross-link gap rather than pretending the registry was loaded.
...
- Pattern files: `02_patterns/PATTERN-contract_first_evidence.md`
