---
decision_id: "PR-210-docs-add-pf-global-02-near-term-commander-prompt"
status: "candidate / decision-atlas / not-authority"
authority: "not-authority"
pr_number: 210
pr_exists_verified: true
merged: true
pr_url: "https://github.com/RayWong1990/ScoutFlow/pull/210"
pr_title: "docs: add PF-GLOBAL-02 near-term commander prompt"
merged_at: "2026-05-06T09:49:36Z"
...
# PR #210 — docs: add PF-GLOBAL-02 near-term commander prompt

## Evidence snapshot

| Field | Value |
|---|---|
| PR | [#210](https://github.com/RayWong1990/ScoutFlow/pull/210) |
| Merged at | `2026-05-06T09:49:36Z` |
| Cluster | `C05 PF-LP Run-2 / Window-2 / PF-GLOBAL / PF-C3` |
| Decision kind | `other` |
...
Added PF-GLOBAL-02 near-term commander prompt dispatch output; keeps commander guidance within docs/research/post-frozen boundaries.
...
The chosen decision was to merge **docs: add PF-GLOBAL-02 near-term commander prompt** as a other item inside **C05 PF-LP Run-2 / Window-2 / PF-GLOBAL / PF-C3**. The operational payload, as observed from the PR metadata/body summary, was: Added PF-GLOBAL-02 near-term commander prompt dispatch output; keeps commander guidance within docs/research/post-frozen boundaries.
