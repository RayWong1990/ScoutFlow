---
decision_id: "PR-212-docs-add-pf-global-04-proof-scorecard-schema"
status: "candidate / decision-atlas / not-authority"
authority: "not-authority"
pr_number: 212
pr_exists_verified: true
merged: true
pr_url: "https://github.com/RayWong1990/ScoutFlow/pull/212"
pr_title: "docs: add PF-GLOBAL-04 proof scorecard schema"
merged_at: "2026-05-06T09:50:04Z"
...
# PR #212 — docs: add PF-GLOBAL-04 proof scorecard schema

## Evidence snapshot

| Field | Value |
|---|---|
| PR | [#212](https://github.com/RayWong1990/ScoutFlow/pull/212) |
| Merged at | `2026-05-06T09:50:04Z` |
| Cluster | `C05 PF-LP Run-2 / Window-2 / PF-GLOBAL / PF-C3` |
...
Added PF-GLOBAL-04 proof scorecard schema dispatch output; creates structured proof scoring for post-frozen work.
...
The chosen decision was to merge **docs: add PF-GLOBAL-04 proof scorecard schema** as a contract item inside **C05 PF-LP Run-2 / Window-2 / PF-GLOBAL / PF-C3**. The operational payload, as observed from the PR metadata/body summary, was: Added PF-GLOBAL-04 proof scorecard schema dispatch output; creates structured proof scoring for post-frozen work.
...
The immediate outcome is a merged checkpoint in the PR ledger at `2026-05-06T09:50:04Z`. Downstream, this card should be read together with linked patterns `contract_first_evidence` and with the amend chain `{'amends': [], 'amended_by': [], 'related_prs': []}`. No U11 anti-pattern ID is attached because the U11 registry was not available in this build; inventing AP IDs would make the atlas less useful. The package therefore records a cross-link gap rather than pretending the registry was loaded.
