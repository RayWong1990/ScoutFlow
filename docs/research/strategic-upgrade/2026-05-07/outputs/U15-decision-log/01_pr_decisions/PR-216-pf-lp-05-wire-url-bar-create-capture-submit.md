---
decision_id: "PR-216-pf-lp-05-wire-url-bar-create-capture-submit"
status: "candidate / decision-atlas / not-authority"
authority: "not-authority"
pr_number: 216
pr_exists_verified: true
merged: true
pr_url: "https://github.com/RayWong1990/ScoutFlow/pull/216"
pr_title: "PF-LP-05: wire url bar create capture submit"
merged_at: "2026-05-06T10:03:32Z"
...
# PR #216 — PF-LP-05: wire url bar create capture submit

## Evidence snapshot

| Field | Value |
|---|---|
| PR | [#216](https://github.com/RayWong1990/ScoutFlow/pull/216) |
| Merged at | `2026-05-06T10:03:32Z` |
| Cluster | `C05 PF-LP Run-2 / Window-2 / PF-GLOBAL / PF-C3` |
...
Wired URL bar create action to createCapture with loading/error states and bounded callback seam; added scoped repair notes for the bounded app diff.
...
The chosen decision was to merge **PF-LP-05: wire url bar create capture submit** as a implementation-boundary item inside **C05 PF-LP Run-2 / Window-2 / PF-GLOBAL / PF-C3**. The operational payload, as observed from the PR metadata/body summary, was: Wired URL bar create action to createCapture with loading/error states and bounded callback seam; added scoped repair notes for the bounded app diff.
