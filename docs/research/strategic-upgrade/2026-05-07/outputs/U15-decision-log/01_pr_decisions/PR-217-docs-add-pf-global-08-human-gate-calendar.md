---
decision_id: "PR-217-docs-add-pf-global-08-human-gate-calendar"
status: "candidate / decision-atlas / not-authority"
authority: "not-authority"
pr_number: 217
pr_exists_verified: true
merged: true
pr_url: "https://github.com/RayWong1990/ScoutFlow/pull/217"
pr_title: "docs: add PF-GLOBAL-08 human gate calendar"
merged_at: "2026-05-06T09:51:16Z"
...
# PR #217 — docs: add PF-GLOBAL-08 human gate calendar

## Evidence snapshot

| Field | Value |
|---|---|
| PR | [#217](https://github.com/RayWong1990/ScoutFlow/pull/217) |
| Merged at | `2026-05-06T09:51:16Z` |
| Cluster | `C05 PF-LP Run-2 / Window-2 / PF-GLOBAL / PF-C3` |
...
Added PF-GLOBAL-08 human gate calendar dispatch output; makes human-in-loop gates explicit.
...
The chosen decision was to merge **docs: add PF-GLOBAL-08 human gate calendar** as a boundary item inside **C05 PF-LP Run-2 / Window-2 / PF-GLOBAL / PF-C3**. The operational payload, as observed from the PR metadata/body summary, was: Added PF-GLOBAL-08 human gate calendar dispatch output; makes human-in-loop gates explicit.
...
The immediate outcome is a merged checkpoint in the PR ledger at `2026-05-06T09:51:16Z`. Downstream, this card should be read together with linked patterns `boundary_preservation` and with the amend chain `{'amends': [], 'amended_by': [], 'related_prs': []}`. No U11 anti-pattern ID is attached because the U11 registry was not available in this build; inventing AP IDs would make the atlas less useful. The package therefore records a cross-link gap rather than pretending the registry was loaded.
