---
decision_id: "PR-218-docs-add-pf-global-09-kill-switch-registry"
status: "candidate / decision-atlas / not-authority"
authority: "not-authority"
pr_number: 218
pr_exists_verified: true
merged: true
pr_url: "https://github.com/RayWong1990/ScoutFlow/pull/218"
pr_title: "docs: add PF-GLOBAL-09 kill switch registry"
merged_at: "2026-05-06T09:51:30Z"
...
linked_patterns: ["boundary_preservation"]
linked_anti_patterns: []
canonical_decision_log_unchanged: true
---

# PR #218 — docs: add PF-GLOBAL-09 kill switch registry

## Evidence snapshot

| Field | Value |
|---|---|
| PR | [#218](https://github.com/RayWong1990/ScoutFlow/pull/218) |
| Merged at | `2026-05-06T09:51:30Z` |
| Cluster | `C05 PF-LP Run-2 / Window-2 / PF-GLOBAL / PF-C3` |
...
Added PF-GLOBAL-09 kill switch registry dispatch output; maps stoppability and operator control points.
...
The chosen decision was to merge **docs: add PF-GLOBAL-09 kill switch registry** as a boundary item inside **C05 PF-LP Run-2 / Window-2 / PF-GLOBAL / PF-C3**. The operational payload, as observed from the PR metadata/body summary, was: Added PF-GLOBAL-09 kill switch registry dispatch output; maps stoppability and operator control points.
...
The immediate outcome is a merged checkpoint in the PR ledger at `2026-05-06T09:51:30Z`. Downstream, this card should be read together with linked patterns `boundary_preservation` and with the amend chain `{'amends': [], 'amended_by': [], 'related_prs': []}`. No U11 anti-pattern ID is attached because the U11 registry was not available in this build; inventing AP IDs would make the atlas less useful. The package therefore records a cross-link gap rather than pretending the registry was loaded.
...
- Pattern files: `02_patterns/PATTERN-boundary_preservation.md`
