---
decision_id: "PR-221-docs-add-pf-global-12-reservoir-closeout-map"
status: "candidate / decision-atlas / not-authority"
authority: "not-authority"
pr_number: 221
pr_exists_verified: true
merged: true
pr_url: "https://github.com/RayWong1990/ScoutFlow/pull/221"
pr_title: "docs: add PF-GLOBAL-12 reservoir closeout map"
merged_at: "2026-05-06T09:52:12Z"
...
# PR #221 — docs: add PF-GLOBAL-12 reservoir closeout map

## Evidence snapshot

| Field | Value |
|---|---|
| PR | [#221](https://github.com/RayWong1990/ScoutFlow/pull/221) |
| Merged at | `2026-05-06T09:52:12Z` |
| Cluster | `C05 PF-LP Run-2 / Window-2 / PF-GLOBAL / PF-C3` |
...
Added PF-GLOBAL-12 reservoir closeout map dispatch output; maps how reservoir items should close or remain deferred.
...
The chosen decision was to merge **docs: add PF-GLOBAL-12 reservoir closeout map** as a audit-evidence item inside **C05 PF-LP Run-2 / Window-2 / PF-GLOBAL / PF-C3**. The operational payload, as observed from the PR metadata/body summary, was: Added PF-GLOBAL-12 reservoir closeout map dispatch output; maps how reservoir items should close or remain deferred.
