---
decision_id: "PR-222-docs-add-pf-c3-02-keep-list"
status: "candidate / decision-atlas / not-authority"
authority: "not-authority"
pr_number: 222
pr_exists_verified: true
merged: true
pr_url: "https://github.com/RayWong1990/ScoutFlow/pull/222"
pr_title: "docs: add PF-C3-02 keep list"
merged_at: "2026-05-06T09:53:12Z"
...
# PR #222 — docs: add PF-C3-02 keep list

## Evidence snapshot

| Field | Value |
|---|---|
| PR | [#222](https://github.com/RayWong1990/ScoutFlow/pull/222) |
| Merged at | `2026-05-06T09:53:12Z` |
| Cluster | `C05 PF-LP Run-2 / Window-2 / PF-GLOBAL / PF-C3` |
| Decision kind | `other` |
...
Added PF-C3-02 keep list dispatch output; records object-retention decisions for PF-C3.
...
The chosen decision was to merge **docs: add PF-C3-02 keep list** as a other item inside **C05 PF-LP Run-2 / Window-2 / PF-GLOBAL / PF-C3**. The operational payload, as observed from the PR metadata/body summary, was: Added PF-C3-02 keep list dispatch output; records object-retention decisions for PF-C3.
