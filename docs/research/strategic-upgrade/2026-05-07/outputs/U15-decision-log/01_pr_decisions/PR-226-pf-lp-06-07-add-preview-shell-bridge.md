---
decision_id: "PR-226-pf-lp-06-07-add-preview-shell-bridge"
status: "candidate / decision-atlas / not-authority"
authority: "not-authority"
pr_number: 226
pr_exists_verified: true
merged: true
pr_url: "https://github.com/RayWong1990/ScoutFlow/pull/226"
pr_title: "PF-LP-06/07: add preview shell bridge"
merged_at: "2026-05-06T10:03:33Z"
...
# PR #226 — PF-LP-06/07: add preview shell bridge

## Evidence snapshot

| Field | Value |
|---|---|
| PR | [#226](https://github.com/RayWong1990/ScoutFlow/pull/226) |
| Merged at | `2026-05-06T10:03:33Z` |
| Cluster | `C05 PF-LP Run-2 / Window-2 / PF-GLOBAL / PF-C3` |
...
Added bounded shell seam from URL bar capture creation into preview loading, reset stale preview state, and mounted preview/dry-run commit surfaces.
...
The chosen decision was to merge **PF-LP-06/07: add preview shell bridge** as a implementation-boundary item inside **C05 PF-LP Run-2 / Window-2 / PF-GLOBAL / PF-C3**. The operational payload, as observed from the PR metadata/body summary, was: Added bounded shell seam from URL bar capture creation into preview loading, reset stale preview state, and mounted preview/dry-run commit surfaces.
...
The immediate outcome is a merged checkpoint in the PR ledger at `2026-05-06T10:03:33Z`. Downstream, this card should be read together with linked patterns `preview_only_before_write` and with the amend chain `{'amended_by': [239], 'related_prs': [232, 233, 234, 239], 'amends': []}`. No U11 anti-pattern ID is attached because the U11 registry was not available in this build; inventing AP IDs would make the atlas less useful. The package therefore records a cross-link gap rather than pretending the registry was loaded.
