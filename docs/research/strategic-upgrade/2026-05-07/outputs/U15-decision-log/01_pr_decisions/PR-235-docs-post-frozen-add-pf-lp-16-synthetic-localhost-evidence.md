---
decision_id: "PR-235-docs-post-frozen-add-pf-lp-16-synthetic-localhost-evidence"
status: "candidate / decision-atlas / not-authority"
authority: "not-authority"
pr_number: 235
pr_exists_verified: true
merged: true
pr_url: "https://github.com/RayWong1990/ScoutFlow/pull/235"
pr_title: "docs(post-frozen): add PF-LP-16 synthetic localhost evidence"
merged_at: "2026-05-06T11:00:11Z"
...
# PR #235 — docs(post-frozen): add PF-LP-16 synthetic localhost evidence

## Evidence snapshot

| Field | Value |
|---|---|
| PR | [#235](https://github.com/RayWong1990/ScoutFlow/pull/235) |
| Merged at | `2026-05-06T11:00:11Z` |
| Cluster | `C07 Run-2 Evidence / Receipt Closeout` |
| Decision kind | `other` |
...
Recorded synthetic UAT-1 evidence for PF-LP-16 using curl plus JSDOM tests, preserving original URL and classifying copy/download results without browser-execution claims.
...
The chosen decision was to merge **docs(post-frozen): add PF-LP-16 synthetic localhost evidence** as a other item inside **C07 Run-2 Evidence / Receipt Closeout**. The operational payload, as observed from the PR metadata/body summary, was: Recorded synthetic UAT-1 evidence for PF-LP-16 using curl plus JSDOM tests, preserving original URL and classifying copy/download results without browser-execution claims.
...
The immediate outcome is a merged checkpoint in the PR ledger at `2026-05-06T11:00:11Z`. Downstream, this card should be read together with linked patterns `evidence_receipt_readback` and with the amend chain `{'amends': [], 'amended_by': [], 'related_prs': []}`. No U11 anti-pattern ID is attached because the U11 registry was not available in this build; inventing AP IDs would make the atlas less useful. The package therefore records a cross-link gap rather than pretending the registry was loaded.
