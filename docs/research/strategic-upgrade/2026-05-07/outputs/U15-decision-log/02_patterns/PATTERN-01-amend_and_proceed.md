---
pattern_id: amend_and_proceed
title: "Amend and proceed"
...
When a PR or run is valuable enough to keep, but an audit exposes a boundary violation or incomplete evidence, the project records the deviation, narrows the claim, and proceeds rather than pretending the issue did not exist.
