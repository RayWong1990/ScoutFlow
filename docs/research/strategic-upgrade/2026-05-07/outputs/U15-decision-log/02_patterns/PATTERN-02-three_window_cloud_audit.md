---
pattern_id: three_window_cloud_audit
title: "3-window cloud audit"
status: candidate / decision-pattern / not-authority
authority: not-authority
related_prs: []
---

# 3-window cloud audit

## Definition

Separate execution evidence, receipt traceability, and follow-up synthesis into windows so that one successful window does not imply total readiness.
