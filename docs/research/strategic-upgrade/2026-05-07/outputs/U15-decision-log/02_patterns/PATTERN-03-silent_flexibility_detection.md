---
pattern_id: silent_flexibility_detection
title: "Silent flexibility detection"
status: candidate / decision-pattern / not-authority
authority: not-authority
related_prs: []
---

# Silent flexibility detection

## Definition

Detect cases where a boundary was softened by convenience language, synthetic proof, or merged implementation before the authority wording caught up.
...
No direct PR tagged; retained as library pattern for future atlas expansion.
