...
Preserve hard boundaries such as write_enabled=false, no migration, no browser automation, no authority writeback, and allowed paths even when a PR adds useful functionality.
