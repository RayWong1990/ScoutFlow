---
pattern_id: vendor_evaluation_vs_accepted
title: "Vendor evaluation vs accepted"
status: candidate / decision-pattern / not-authority
authority: not-authority
related_prs: []
---

# Vendor evaluation vs accepted

## Definition

Keep vendor, tool, or platform candidates in evaluation state until evidence promotes them; never let a successful fixture imply vendor acceptance.
