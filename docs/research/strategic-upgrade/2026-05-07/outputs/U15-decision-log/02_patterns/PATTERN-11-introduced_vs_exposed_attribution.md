---
pattern_id: introduced_vs_exposed_attribution
title: "Introduced vs exposed attribution"
status: candidate / decision-pattern / not-authority
authority: not-authority
related_prs: [231, 239]
---

# Introduced vs exposed attribution

## Definition

Separate the PR that introduced a condition from the PR that exposed it, especially when audits reveal older scope drift.
