---
pattern_id: truthful_stdout_contract
title: "Truthful stdout contract"
status: candidate / decision-pattern / not-authority
authority: not-authority
related_prs: [231, 239]
---

# Truthful stdout contract

## Definition

Final status must report real counts, gaps, failed gates, and partial completion rather than echoing a desired COMPLETE=true banner.
