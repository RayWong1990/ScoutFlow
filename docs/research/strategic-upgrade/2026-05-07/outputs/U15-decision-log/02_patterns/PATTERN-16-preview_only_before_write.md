---
pattern_id: preview_only_before_write
title: "Preview-only before write"
status: candidate / decision-pattern / not-authority
authority: not-authority
related_prs: [161, 162, 163, 169, 176, 178, 179, 180, 189, 190, 191, 192, 199, 200, 201, 204, 205, 211]
---
...
Render, test, or read back candidate outputs before true writes; preview-only proof must not be over-claimed as committed runtime behavior.
...
#161, #162, #163, #169, #176, #178, #179, #180, #189, #190, #191, #192, #199, #200, #201, #204, #205, #211


```mermaid
flowchart TD
    A[Candidate or PR change] --> B{Boundary / evidence check}
    B -->|clean| C[Keep as candidate decision]
    B -->|gap found| D[Amend / downgrade / block]
    D --> E[Record traceability]
    C --> F[Future promotion gate]
    E --> F
```
