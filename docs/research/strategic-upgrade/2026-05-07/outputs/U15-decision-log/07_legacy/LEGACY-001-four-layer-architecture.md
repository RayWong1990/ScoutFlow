---
decision_id: LEGACY-001-four-layer-architecture-inheritance
...
# Four-layer architecture inheritance

## Candidate legacy claim

ScoutFlow appears to inherit a layered working style: authority, candidate, evidence, and runtime/implementation are separated so that a later reader knows which layer is being touched.
