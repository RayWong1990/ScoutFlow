---
title: P2-LANE1-04-true-write-gate-decision-packet — True-write gate decision packet
...
prerequisites:
  ...
  - P2-LANE1-03-dry-run-commit-validation-matrix
blocks:
...
[claim]
# P2-LANE1-04-true-write-gate-decision-packet — True-write gate decision packet

[claim]
## §1 Mission

[candidate] 生成 true-write gate 的人工决策包，明确哪些 proof 可以进入 gate、哪些 partial 仍必须触发 reject/concern。
...
[claim]
- `docs/research/post-frozen/phase2/lane1/true-write-gate-decision-packet.md`
...
[output]
```yaml
dispatch_id: P2-LANE1-04-true-write-gate-decision-packet
...
[output]
```yaml
P2-LANE1-04-true-write-gate-decision-packet_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
