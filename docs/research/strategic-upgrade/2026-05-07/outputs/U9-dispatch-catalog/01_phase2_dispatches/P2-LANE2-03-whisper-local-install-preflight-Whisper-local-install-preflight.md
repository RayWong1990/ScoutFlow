---
title: P2-LANE2-03-whisper-local-install-preflight — Whisper local install preflight
...
prerequisites:
  ...
  - P2-LANE2-02-yt-dlp-boundary-and-platform-result-remap
blocks:
...
[claim]
# P2-LANE2-03-whisper-local-install-preflight — Whisper local install preflight

[claim]
## §1 Mission

[candidate] 设计 Whisper local install 的 repo-external preflight，不安装、不下载、不创建 ASR runtime，只列出安全证据与失败码。
...
[boundary]
- `docs/research/post-frozen/phase2/lane2/whisper-local-install-preflight.md`
...
[output]
```yaml
dispatch_id: P2-LANE2-03-whisper-local-install-preflight
...
[output]
```yaml
P2-LANE2-03-whisper-local-install-preflight_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
