---
title: P2-LANE2-06-asr-sandbox-redaction-harness — ASR sandbox redaction harness
...
prerequisites:
  ...
  - P2-LANE2-05-voxtral-asr-spike-candidate
blocks:
...
[claim]
# P2-LANE2-06-asr-sandbox-redaction-harness — ASR sandbox redaction harness

[claim]
## §1 Mission

[candidate] 设计 ASR sandbox 的 redaction harness 与 transcript artifact policy，保持 audio_transcript blocked。
...
[boundary]
- `docs/research/post-frozen/phase2/lane2/asr-sandbox-redaction-harness.md`
...
[output]
```yaml
dispatch_id: P2-LANE2-06-asr-sandbox-redaction-harness
...
[output]
```yaml
P2-LANE2-06-asr-sandbox-redaction-harness_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
