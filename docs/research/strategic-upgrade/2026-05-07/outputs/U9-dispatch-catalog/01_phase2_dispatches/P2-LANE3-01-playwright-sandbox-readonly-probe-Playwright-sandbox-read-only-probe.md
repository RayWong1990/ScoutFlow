---
title: P2-LANE3-01-playwright-sandbox-readonly-probe — Playwright sandbox read-only probe
...
[claim]
# P2-LANE3-01-playwright-sandbox-readonly-probe — Playwright sandbox read-only probe

[claim]
## §1 Mission

[candidate] 定义 Playwright sandbox 的 read-only proof surface；本 dispatch 不启动浏览器，只写可审的 isolation 和 failure taxonomy。
...
[claim]
- `docs/research/post-frozen/phase2/lane3/playwright-sandbox-readonly-probe.md`
...
[output]
```yaml
dispatch_id: P2-LANE3-01-playwright-sandbox-readonly-probe
...
[output]
```yaml
P2-LANE3-01-playwright-sandbox-readonly-probe_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
