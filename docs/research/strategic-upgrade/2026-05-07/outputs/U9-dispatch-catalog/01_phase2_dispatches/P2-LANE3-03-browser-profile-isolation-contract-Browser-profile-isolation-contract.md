---
title: P2-LANE3-03-browser-profile-isolation-contract — Browser profile isolation contract
...
prerequisites:
  ...
  - P2-LANE3-02-human-screenshot-verdict-packet
blocks:
...
[claim]
# P2-LANE3-03-browser-profile-isolation-contract — Browser profile isolation contract

[claim]
## §1 Mission

[candidate] 写出 browser profile isolation contract，防止 cookie、profile path、QR image、signed URL 进入 repo 或 evidence。
...
[claim]
- `docs/research/post-frozen/phase2/lane3/browser-profile-isolation-contract.md`
...
[output]
```yaml
dispatch_id: P2-LANE3-03-browser-profile-isolation-contract
...
[output]
```yaml
P2-LANE3-03-browser-profile-isolation-contract_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
