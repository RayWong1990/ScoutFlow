---
title: P2-LANE3-04-login-required-gate-and-consent — Login-required gate and consent
...
prerequisites:
  ...
  - P2-LANE3-03-browser-profile-isolation-contract
blocks:
...
[claim]
# P2-LANE3-04-login-required-gate-and-consent — Login-required gate and consent

[claim]
## §1 Mission

[candidate] 把 login-required 场景拆为 human gate、consent、local-only store、kill switch 与 redaction，不允许 agent 代替用户登录。
...
[claim]
- `docs/research/post-frozen/phase2/lane3/login-required-gate-and-consent.md`
...
[output]
```yaml
dispatch_id: P2-LANE3-04-login-required-gate-and-consent
...
[output]
```yaml
P2-LANE3-04-login-required-gate-and-consent_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
