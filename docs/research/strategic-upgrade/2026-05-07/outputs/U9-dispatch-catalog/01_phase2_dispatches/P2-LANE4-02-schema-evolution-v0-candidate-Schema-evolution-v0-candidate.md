---
title: P2-LANE4-02-schema-evolution-v0-candidate — Schema evolution v0 candidate
...
prerequisites:
  ...
  - P2-LANE4-01-fixture-migration-rollback-plan
blocks:
...
[claim]
# P2-LANE4-02-schema-evolution-v0-candidate — Schema evolution v0 candidate

[claim]
## §1 Mission

[candidate] 把 Signal/Hypothesis/CapturePlan/TopicCard 的 schema evolution v0 作为 candidate DDL/readback，不写入真实迁移目录。
...
[claim]
- `docs/research/post-frozen/phase2/lane4/schema-evolution-v0-candidate.md`
...
[output]
```yaml
dispatch_id: P2-LANE4-02-schema-evolution-v0-candidate
...
[output]
```yaml
P2-LANE4-02-schema-evolution-v0-candidate_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
