---
title: P2-LANE4-04-consumer-pin-abandon-decision — Consumer pin abandon decision
...
prerequisites:
  ...
  - P2-LANE4-03-single-migration-script-dry-run
blocks:
...
[claim]
# P2-LANE4-04-consumer-pin-abandon-decision — Consumer pin abandon decision

[claim]
## §1 Mission

[candidate] 评估 consumer-pin strategy 是否应保留或放弃，避免为 vNext schema 引入脆弱 downstream coupling。
...
[claim]
- `docs/research/post-frozen/phase2/lane4/consumer-pin-abandon-decision.md`
...
[output]
```yaml
dispatch_id: P2-LANE4-04-consumer-pin-abandon-decision
...
[output]
```yaml
P2-LANE4-04-consumer-pin-abandon-decision_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
