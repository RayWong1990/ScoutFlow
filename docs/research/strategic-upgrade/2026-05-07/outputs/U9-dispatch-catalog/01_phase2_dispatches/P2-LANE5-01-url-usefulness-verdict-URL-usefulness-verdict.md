---
title: P2-LANE5-01-url-usefulness-verdict — URL usefulness verdict
...
[claim]
# P2-LANE5-01-url-usefulness-verdict — URL usefulness verdict

[claim]
## §1 Mission

[candidate] 用 three-url proof 的经验设计 URL usefulness verdict，要求 usefulness 与 edit-cost 分开记录。
...
[claim]
- `docs/research/post-frozen/phase2/lane5/url-usefulness-verdict.md`
...
[output]
```yaml
dispatch_id: P2-LANE5-01-url-usefulness-verdict
...
[output]
```yaml
P2-LANE5-01-url-usefulness-verdict_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
