---
title: P2-LANE5-03-candidate-dispatch-ui-shape — Candidate dispatch UI shape
...
prerequisites:
  ...
  - P2-LANE5-02-readonly-signal-preview
blocks:
...
[claim]
# P2-LANE5-03-candidate-dispatch-ui-shape — Candidate dispatch UI shape

[claim]
## §1 Mission

[candidate] 写出 candidate-only dispatch UI 的 IA 与 output schema，使 operator 可审 queue 但不能一键打开 runtime。
...
[claim]
- `docs/research/post-frozen/phase2/lane5/candidate-dispatch-ui-shape.md`
...
[output]
```yaml
dispatch_id: P2-LANE5-03-candidate-dispatch-ui-shape
...
[output]
```yaml
P2-LANE5-03-candidate-dispatch-ui-shape_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
