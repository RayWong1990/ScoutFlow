---
title: P2-LANE5-04-lp001-risk-recheck — LP-001 risk recheck
...
prerequisites:
  ...
  - P2-LANE5-03-candidate-dispatch-ui-shape
blocks:
...
[claim]
# P2-LANE5-04-lp001-risk-recheck — LP-001 risk recheck

[claim]
## §1 Mission

[candidate] 对 Signal Workbench 的每个入口跑 LP-001 risk recheck，证明 recommendation/keyword/RAW gap 不会直接变 capture。
...
[risk]
- `docs/research/post-frozen/phase2/lane5/lp001-risk-recheck.md`
...
[output]
```yaml
dispatch_id: P2-LANE5-04-lp001-risk-recheck
...
[output]
```yaml
P2-LANE5-04-lp001-risk-recheck_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
