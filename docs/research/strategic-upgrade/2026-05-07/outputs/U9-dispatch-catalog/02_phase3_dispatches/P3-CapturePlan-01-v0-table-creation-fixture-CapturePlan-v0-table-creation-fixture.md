---
title: P3-CapturePlan-01-v0-table-creation-fixture — CapturePlan v0 table creation fixture
...
[claim]
# P3-CapturePlan-01-v0-table-creation-fixture — CapturePlan v0 table creation fixture

[claim]
## §1 Mission

[candidate] 为 CapturePlan v0→v1 准备 table creation fixture，入口必须先过 LP-001。
...
[plan]
- `docs/research/post-frozen/phase3/captureplan/01-v0-table-creation-fixture.md`
...
[output]
```yaml
dispatch_id: P3-CapturePlan-01-v0-table-creation-fixture
...
[output]
```yaml
P3-CapturePlan-01-v0-table-creation-fixture_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
