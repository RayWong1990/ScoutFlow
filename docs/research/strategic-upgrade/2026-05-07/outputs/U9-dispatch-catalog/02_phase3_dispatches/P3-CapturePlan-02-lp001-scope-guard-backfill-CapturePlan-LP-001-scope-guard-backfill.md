---
title: P3-CapturePlan-02-lp001-scope-guard-backfill — CapturePlan LP-001 scope guard backfill
...
prerequisites:
  ...
  - CapturePlan v0 contract readback
  - P3-CapturePlan-01-v0-table-creation-fixture
blocks:
...
[claim]
# P3-CapturePlan-02-lp001-scope-guard-backfill — CapturePlan LP-001 scope guard backfill

[claim]
## §1 Mission

[candidate] 回填 scope guard examples，证明 recommendation / keyword / RAW gap 不能直接创建 capture。
...
[boundary] Lane-specific boundary: CapturePlan v0→v1 必须优先受 LP-001 约束，不得把 recommendation / keyword / RAW gap 直接变 capture。
...
2. **Pass 2 — scope proof** — Map this task to PF-C3 / CapturePlan and identify exactly which prior proof or partial result is being used; never infer a runtime gate from a candidate doc.
...
[plan]
- `docs/research/post-frozen/phase3/captureplan/02-lp001-scope-guard-backfill.md`
- `docs/specs/post-frozen/captureplan-v1-candidate-contract.md`
...
[output]
```yaml
dispatch_id: P3-CapturePlan-02-lp001-scope-guard-backfill
...
[output]
```yaml
P3-CapturePlan-02-lp001-scope-guard-backfill_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
