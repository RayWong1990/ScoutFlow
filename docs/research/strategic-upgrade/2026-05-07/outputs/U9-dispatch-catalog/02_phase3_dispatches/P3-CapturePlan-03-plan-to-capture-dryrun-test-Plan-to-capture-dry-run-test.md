---
title: P3-CapturePlan-03-plan-to-capture-dryrun-test — Plan-to-capture dry-run test
...
prerequisites:
  ...
  - P3-CapturePlan-02-lp001-scope-guard-backfill
blocks:
...
[claim]
# P3-CapturePlan-03-plan-to-capture-dryrun-test — Plan-to-capture dry-run test

[claim]
## §1 Mission

[candidate] 设计 plan-to-capture 的 dry-run test，只有 human-approved manual_url 才能进入 capture candidate。
...
[plan]
- `docs/research/post-frozen/phase3/captureplan/03-plan-to-capture-dryrun-test.md`
...
[output]
```yaml
dispatch_id: P3-CapturePlan-03-plan-to-capture-dryrun-test
...
[output]
```yaml
P3-CapturePlan-03-plan-to-capture-dryrun-test_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
