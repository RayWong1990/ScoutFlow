---
title: P3-Hypothesis-01-v0-table-creation-fixture — Hypothesis v0 table creation fixture
...
[claim]
# P3-Hypothesis-01-v0-table-creation-fixture — Hypothesis v0 table creation fixture

[claim]
## §1 Mission

[candidate] 为 Hypothesis v0→v1 准备 table creation fixture 与 evidence_source 字段候选。
...
[claim]
- `docs/research/post-frozen/phase3/hypothesis/01-v0-table-creation-fixture.md`
...
[output]
```yaml
dispatch_id: P3-Hypothesis-01-v0-table-creation-fixture
...
[output]
```yaml
P3-Hypothesis-01-v0-table-creation-fixture_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
