---
title: P3-Hypothesis-02-evidence-source-backfill — Hypothesis evidence source backfill
...
prerequisites:
  ...
  - P3-Hypothesis-01-v0-table-creation-fixture
blocks:
...
[claim]
# P3-Hypothesis-02-evidence-source-backfill — Hypothesis evidence source backfill

[claim]
## §1 Mission

[candidate] 构造 evidence source backfill 的样例，把 trust trace 与 hypothesis claim 分层。
...
[claim]
- `docs/research/post-frozen/phase3/hypothesis/02-evidence-source-backfill.md`
...
[output]
```yaml
dispatch_id: P3-Hypothesis-02-evidence-source-backfill
...
[output]
```yaml
P3-Hypothesis-02-evidence-source-backfill_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
