---
title: P3-Hypothesis-03-comparison-state-machine-test — Hypothesis comparison state-machine test
...
prerequisites:
  ...
  - P3-Hypothesis-02-evidence-source-backfill
blocks:
...
[claim]
# P3-Hypothesis-03-comparison-state-machine-test — Hypothesis comparison state-machine test

[claim]
## §1 Mission

[candidate] 设计 comparison / supersede / rejected 状态机测试，不改现有 capture state words。
...
[claim]
- `docs/research/post-frozen/phase3/hypothesis/03-comparison-state-machine-test.md`
...
[output]
```yaml
dispatch_id: P3-Hypothesis-03-comparison-state-machine-test
...
[output]
```yaml
P3-Hypothesis-03-comparison-state-machine-test_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
