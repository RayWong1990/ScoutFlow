---
title: P3-Signal-01-v0-table-creation-fixture — Signal v0 table creation fixture
...
[claim]
# P3-Signal-01-v0-table-creation-fixture — Signal v0 table creation fixture

[claim]
## §1 Mission

[candidate] 为 Signal v0→v1 准备 table creation fixture 与 candidate DDL，不触发真实 migration。
...
[claim]
- `docs/research/post-frozen/phase3/signal/01-v0-table-creation-fixture.md`
...
[output]
```yaml
dispatch_id: P3-Signal-01-v0-table-creation-fixture
...
[output]
```yaml
P3-Signal-01-v0-table-creation-fixture_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
