---
title: P3-Signal-02-sample-backfill-candidate — Signal sample backfill candidate
...
prerequisites:
  ...
  - Signal v0 contract readback
  - P3-Signal-01-v0-table-creation-fixture
blocks:
...
[claim]
# P3-Signal-02-sample-backfill-candidate — Signal sample backfill candidate

[claim]
## §1 Mission

[candidate] 从 Run-3 C1 proof set 抽取 synthetic sample backfill，验证 fields 对 usefulness/edit-cost 足够。
...
[boundary] Lane-specific boundary: Signal v0→v1 只允许 candidate contract 与 fixture，不得把 signal 写成 authority DB object。
...
2. **Pass 2 — scope proof** — Map this task to PF-C3 / Signal and identify exactly which prior proof or partial result is being used; never infer a runtime gate from a candidate doc.
...
[claim]
- `docs/research/post-frozen/phase3/signal/02-sample-backfill-candidate.md`
- `docs/specs/post-frozen/signal-v1-candidate-contract.md`
...
[output]
```yaml
dispatch_id: P3-Signal-02-sample-backfill-candidate
...
[output]
```yaml
P3-Signal-02-sample-backfill-candidate_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
