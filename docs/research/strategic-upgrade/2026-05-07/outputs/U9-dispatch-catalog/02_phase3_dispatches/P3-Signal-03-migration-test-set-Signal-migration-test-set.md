---
title: P3-Signal-03-migration-test-set — Signal migration test set
...
prerequisites:
  ...
  - P3-Signal-02-sample-backfill-candidate
blocks:
...
[claim]
# P3-Signal-03-migration-test-set — Signal migration test set

[claim]
## §1 Mission

[candidate] 设计 Signal migration test set 的 fixtures、expected failures、rollback assertions。
...
[boundary]
- `docs/research/post-frozen/phase3/signal/03-migration-test-set.md`
...
[output]
```yaml
dispatch_id: P3-Signal-03-migration-test-set
...
[output]
```yaml
P3-Signal-03-migration-test-set_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
