---
title: P3-Signal-04-signal-scoring-vocab-promotion — Signal scoring vocabulary promotion
...
prerequisites:
  ...
  - P3-Signal-03-migration-test-set
blocks:
...
[claim]
# P3-Signal-04-signal-scoring-vocab-promotion — Signal scoring vocabulary promotion

[claim]
## §1 Mission

[candidate] 把 signal scoring vocabulary 从 glossary 候选压缩成 v1 contract appendix。
...
[claim]
- `docs/research/post-frozen/phase3/signal/04-signal-scoring-vocab-promotion.md`
...
[output]
```yaml
dispatch_id: P3-Signal-04-signal-scoring-vocab-promotion
...
[output]
```yaml
P3-Signal-04-signal-scoring-vocab-promotion_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
