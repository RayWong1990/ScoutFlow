---
title: P3-TopicCard-01-lite-v0-to-v1-contract — TopicCard lite v0 to v1 contract
...
[claim]
# P3-TopicCard-01-lite-v0-to-v1-contract — TopicCard lite v0 to v1 contract

[claim]
## §1 Mission

[candidate] 把 topic-card-lite v0 的 successful proof pair 收束为 v1 candidate contract。
...
[claim]
- `docs/research/post-frozen/phase3/topiccard/01-lite-v0-to-v1-contract.md`
...
[output]
```yaml
dispatch_id: P3-TopicCard-01-lite-v0-to-v1-contract
...
[output]
```yaml
P3-TopicCard-01-lite-v0-to-v1-contract_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
