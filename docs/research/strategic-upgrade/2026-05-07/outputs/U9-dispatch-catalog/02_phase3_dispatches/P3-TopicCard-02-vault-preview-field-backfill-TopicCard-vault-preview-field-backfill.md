---
title: P3-TopicCard-02-vault-preview-field-backfill — TopicCard vault preview field backfill
...
owner_tool: Codex Desktop / Claude Code UX reviewer
...
prerequisites:
  ...
  - TopicCard v0 contract readback
  - P3-TopicCard-01-lite-v0-to-v1-contract
blocks:
...
[claim]
# P3-TopicCard-02-vault-preview-field-backfill — TopicCard vault preview field backfill

[claim]
## §1 Mission

[candidate] 定义 vault preview field backfill 的 fixtures，证明 preview 与 RAW knowledge 仍是不同层。
...
[boundary] Lane-specific boundary: TopicCard lite/v1/v2 只表示 preview/candidate output，不等于 RAW knowledge success 或 vault true write。
...
2. **Pass 2 — scope proof** — Map this task to PF-C1 / TopicCard and identify exactly which prior proof or partial result is being used; never infer a runtime gate from a candidate doc.
...
[claim]
- `docs/research/post-frozen/phase3/topiccard/02-vault-preview-field-backfill.md`
- `docs/specs/post-frozen/topiccard-v1-candidate-contract.md`
...
[output]
```yaml
dispatch_id: P3-TopicCard-02-vault-preview-field-backfill
...
[output]
```yaml
P3-TopicCard-02-vault-preview-field-backfill_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
