---
title: P3-TopicCard-03-topic-card-v1-migration-test — TopicCard v1 migration test
...
prerequisites:
  ...
  - P3-TopicCard-02-vault-preview-field-backfill
blocks:
...
[claim]
# P3-TopicCard-03-topic-card-v1-migration-test — TopicCard v1 migration test

[claim]
## §1 Mission

[candidate] 设计 TopicCard v1 migration test 与 rollback matrix，保持 can_open_migration false。
...
[boundary]
- `docs/research/post-frozen/phase3/topiccard/03-topic-card-v1-migration-test.md`
...
[output]
```yaml
dispatch_id: P3-TopicCard-03-topic-card-v1-migration-test
...
[output]
```yaml
P3-TopicCard-03-topic-card-v1-migration-test_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
