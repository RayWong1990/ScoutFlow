---
title: P3-TopicCard-04-v1-to-v2-output-schema — TopicCard v1 to v2 output schema
...
prerequisites:
  ...
  - P3-TopicCard-03-topic-card-v1-migration-test
blocks:
...
[claim]
# P3-TopicCard-04-v1-to-v2-output-schema — TopicCard v1 to v2 output schema

[claim]
## §1 Mission

[candidate] 准备 v1→v2 output schema，加入 edit-cost、usefulness、evidence_depth 字段。
...
[deliverable]
- `docs/research/post-frozen/phase3/topiccard/04-v1-to-v2-output-schema.md`
...
[output]
```yaml
dispatch_id: P3-TopicCard-04-v1-to-v2-output-schema
...
[output]
```yaml
P3-TopicCard-04-v1-to-v2-output-schema_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
