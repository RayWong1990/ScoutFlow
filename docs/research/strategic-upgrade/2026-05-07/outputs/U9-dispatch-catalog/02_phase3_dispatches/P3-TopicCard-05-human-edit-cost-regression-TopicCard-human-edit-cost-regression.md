---
title: P3-TopicCard-05-human-edit-cost-regression — TopicCard human edit cost regression
...
prerequisites:
  ...
  - P3-TopicCard-04-v1-to-v2-output-schema
blocks:
...
[claim]
# P3-TopicCard-05-human-edit-cost-regression — TopicCard human edit cost regression

[claim]
## §1 Mission

[candidate] 建立 human edit-cost regression set，防止 topic-card 输出越写越长、越审越贵。
...
[claim]
- `docs/research/post-frozen/phase3/topiccard/05-human-edit-cost-regression.md`
...
[output]
```yaml
dispatch_id: P3-TopicCard-05-human-edit-cost-regression
...
[output]
```yaml
P3-TopicCard-05-human-edit-cost-regression_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
