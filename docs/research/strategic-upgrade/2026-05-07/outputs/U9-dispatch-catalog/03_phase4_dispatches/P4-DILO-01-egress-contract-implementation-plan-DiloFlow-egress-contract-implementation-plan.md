---
title: P4-DILO-01-egress-contract-implementation-plan — DiloFlow egress contract implementation plan
...
owner_tool: Codex Desktop / RAW/DiloFlow reviewer
...
[claim]
# P4-DILO-01-egress-contract-implementation-plan — DiloFlow egress contract implementation plan

[claim]
## §1 Mission

[candidate] 写出 DiloFlow egress contract 的 implementation plan，保持 downstream handoff 是 manifest，不是 authority 反写。
...
[boundary] Lane-specific boundary: DiloFlow handoff 是 egress candidate；不得把 downstream manifest 反写为 ScoutFlow authority。
...
2. **Pass 2 — scope proof** — Map this task to egress / DILO and identify exactly which prior proof or partial result is being used; never infer a runtime gate from a candidate doc.
...
[plan]
- `docs/research/post-frozen/phase4/diloflow/egress-contract-implementation-plan.md`
...
[output]
```yaml
dispatch_id: P4-DILO-01-egress-contract-implementation-plan
...
[output]
```yaml
P4-DILO-01-egress-contract-implementation-plan_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
