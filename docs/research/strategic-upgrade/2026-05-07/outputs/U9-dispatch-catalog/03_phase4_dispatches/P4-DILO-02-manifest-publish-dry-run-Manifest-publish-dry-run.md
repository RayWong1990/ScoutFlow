---
title: P4-DILO-02-manifest-publish-dry-run — Manifest publish dry-run
...
prerequisites:
  ...
  - P4-DILO-01-egress-contract-implementation-plan
blocks:
...
[claim]
# P4-DILO-02-manifest-publish-dry-run — Manifest publish dry-run

[claim]
## §1 Mission

[candidate] 设计 manifest publish dry-run，要求 checksum、source trace、supersede relation 与 local-only path 全部可审。
...
[claim]
- `docs/research/post-frozen/phase4/diloflow/manifest-publish-dry-run.md`
...
[output]
```yaml
dispatch_id: P4-DILO-02-manifest-publish-dry-run
...
[output]
```yaml
P4-DILO-02-manifest-publish-dry-run_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
