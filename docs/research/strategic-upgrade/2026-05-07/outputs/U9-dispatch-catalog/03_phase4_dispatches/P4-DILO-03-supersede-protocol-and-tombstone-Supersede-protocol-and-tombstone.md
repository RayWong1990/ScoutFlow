---
title: P4-DILO-03-supersede-protocol-and-tombstone — Supersede protocol and tombstone
...
prerequisites:
  ...
  - P4-DILO-02-manifest-publish-dry-run
blocks:
...
[claim]
# P4-DILO-03-supersede-protocol-and-tombstone — Supersede protocol and tombstone

[claim]
## §1 Mission

[candidate] 定义 supersede protocol 与 tombstone rules，防止重复 handoff、重复引用和 stale script seed。
...
[claim]
- `docs/research/post-frozen/phase4/diloflow/supersede-protocol-and-tombstone.md`
...
[output]
```yaml
dispatch_id: P4-DILO-03-supersede-protocol-and-tombstone
...
[output]
```yaml
P4-DILO-03-supersede-protocol-and-tombstone_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
