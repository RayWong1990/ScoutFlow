---
title: P4-DILO-04-diloflow-readback-reconciliation — DiloFlow readback reconciliation
...
prerequisites:
  ...
  - P4-DILO-03-supersede-protocol-and-tombstone
blocks:
...
[claim]
# P4-DILO-04-diloflow-readback-reconciliation — DiloFlow readback reconciliation

[claim]
## §1 Mission

[candidate] 设计 DiloFlow readback reconciliation，把 partial、missing、superseded 三类结果分开记录。
...
[claim]
- `docs/research/post-frozen/phase4/diloflow/readback-reconciliation.md`
...
[output]
```yaml
dispatch_id: P4-DILO-04-diloflow-readback-reconciliation
...
[output]
```yaml
P4-DILO-04-diloflow-readback-reconciliation_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
