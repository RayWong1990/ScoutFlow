---
title: P4-HERMES-01-agent-intent-contract — Hermes agent intent contract
...
[claim]
# P4-HERMES-01-agent-intent-contract — Hermes agent intent contract

[claim]
## §1 Mission

[candidate] 把 Hermes agent intent contract 写成 read-only coordination layer，不允许 agent 直接写 SQLite/FS authority。
...
[claim]
- `docs/research/post-frozen/phase4/hermes/agent-intent-contract.md`
...
[output]
```yaml
dispatch_id: P4-HERMES-01-agent-intent-contract
...
[output]
```yaml
P4-HERMES-01-agent-intent-contract_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
