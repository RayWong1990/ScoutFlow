---
title: P4-HERMES-02-review-queue-coordination — Hermes review queue coordination
...
owner_tool: Codex Desktop / Hermes reviewer
...
prerequisites:
  ...
  - P4-HERMES-01-agent-intent-contract
blocks:
...
[claim]
# P4-HERMES-02-review-queue-coordination — Hermes review queue coordination

[claim]
## §1 Mission

[candidate] 设计 review queue coordination，要求 single writer、multi reviewer 与 truthful stdout 保持一致。
...
[boundary] Lane-specific boundary: Hermes/agent integration 仅是 coordination candidate；不得让 agent 绕过 API 或 authority ledger。
...
2. **Pass 2 — scope proof** — Map this task to agent / HERMES and identify exactly which prior proof or partial result is being used; never infer a runtime gate from a candidate doc.
...
[claim]
- `docs/research/post-frozen/phase4/hermes/review-queue-coordination.md`
...
[output]
```yaml
dispatch_id: P4-HERMES-02-review-queue-coordination
...
[output]
```yaml
P4-HERMES-02-review-queue-coordination_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
