---
title: P4-HERMES-03-tool-truthful-stdout-bridge — Tool truthful stdout bridge
...
prerequisites:
  ...
  - P4-HERMES-02-review-queue-coordination
blocks:
...
[claim]
# P4-HERMES-03-tool-truthful-stdout-bridge — Tool truthful stdout bridge

[claim]
## §1 Mission

[candidate] 为 Codex/CC/Hermes 统一 truthful stdout bridge，避免 partial 被包装成 clear。
...
[claim]
- `docs/research/post-frozen/phase4/hermes/tool-truthful-stdout-bridge.md`
...
[output]
```yaml
dispatch_id: P4-HERMES-03-tool-truthful-stdout-bridge
...
[output]
```yaml
P4-HERMES-03-tool-truthful-stdout-bridge_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
