---
title: P4-WB-01-signal-list-readonly-preview — Signal list read-only preview
...
[claim]
# P4-WB-01-signal-list-readonly-preview — Signal list read-only preview

[claim]
## §1 Mission

[candidate] 把 Signal list 做成 read-only preview dispatch，要求 source trace、usefulness、risk label 全部可见但不可创建 capture。
...
[claim]
- `docs/research/post-frozen/phase4/workbench/signal-list-readonly-preview.md`
...
[output]
```yaml
dispatch_id: P4-WB-01-signal-list-readonly-preview
...
[output]
```yaml
P4-WB-01-signal-list-readonly-preview_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
