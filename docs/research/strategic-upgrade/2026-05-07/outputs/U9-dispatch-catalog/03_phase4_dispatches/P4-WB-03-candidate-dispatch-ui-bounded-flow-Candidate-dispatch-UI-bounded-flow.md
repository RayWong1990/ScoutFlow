---
title: P4-WB-03-candidate-dispatch-ui-bounded-flow — Candidate dispatch UI bounded flow
...
prerequisites:
  ...
  - P4-WB-02-recommendation-engine-candidate-only
blocks:
...
[claim]
# P4-WB-03-candidate-dispatch-ui-bounded-flow — Candidate dispatch UI bounded flow

[claim]
## §1 Mission

[candidate] 设计 candidate dispatch UI 的 bounded flow，所有按钮只产生 draft prompt，不产生实际执行。
...
2. **Pass 2 — scope proof** — Map this task to PF-C4 / WB and identify exactly which prior proof or partial result is being used; never infer a runtime gate from a candidate doc.
...
[claim]
- `docs/research/post-frozen/phase4/workbench/candidate-dispatch-ui-bounded-flow.md`
...
[output]
```yaml
dispatch_id: P4-WB-03-candidate-dispatch-ui-bounded-flow
...
[output]
```yaml
P4-WB-03-candidate-dispatch-ui-bounded-flow_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
