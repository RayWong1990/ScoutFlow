---
title: P4-WB-04-batch-capture-scope-gate-enforcement — Batch capture scope gate enforcement
...
owner_tool: Codex Desktop / Claude Code reviewer
...
prerequisites:
  ...
  - P4-WB-03-candidate-dispatch-ui-bounded-flow
blocks:
...
[claim]
# P4-WB-04-batch-capture-scope-gate-enforcement — Batch capture scope gate enforcement

[claim]
## §1 Mission

[candidate] 对 batch capture 场景写出 scope gate enforcement，批量入口必须先拆成 reviewable plan。
...
2. **Pass 2 — scope proof** — Map this task to PF-LP / WB and identify exactly which prior proof or partial result is being used; never infer a runtime gate from a candidate doc.
...
[claim]
- `docs/research/post-frozen/phase4/workbench/batch-capture-scope-gate-enforcement.md`
...
[output]
```yaml
dispatch_id: P4-WB-04-batch-capture-scope-gate-enforcement
...
[output]
```yaml
P4-WB-04-batch-capture-scope-gate-enforcement_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
