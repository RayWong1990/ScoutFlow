---
title: P4-XTEST-01-cross-system-end-to-end-test-set — Cross-system end-to-end test set
...
[claim]
# P4-XTEST-01-cross-system-end-to-end-test-set — Cross-system end-to-end test set

[claim]
## §1 Mission

[candidate] 设计 ScoutFlow→RAW→DiloFlow 的 cross-system test set，所有 downstream step 只做 candidate readback。
...
[boundary] Lane-specific boundary: Cross-system test 仅用于 proof matrix；不得把 partial proof 写成 pass。
...
2. **Pass 2 — scope proof** — Map this task to PF-C4 / XTEST and identify exactly which prior proof or partial result is being used; never infer a runtime gate from a candidate doc.
...
[claim]
- `docs/research/post-frozen/phase4/cross-system/end-to-end-test-set.md`
...
[output]
```yaml
dispatch_id: P4-XTEST-01-cross-system-end-to-end-test-set
...
[output]
```yaml
P4-XTEST-01-cross-system-end-to-end-test-set_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
