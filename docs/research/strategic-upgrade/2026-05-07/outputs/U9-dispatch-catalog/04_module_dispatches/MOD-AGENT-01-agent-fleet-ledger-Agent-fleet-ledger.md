---
title: MOD-AGENT-01-agent-fleet-ledger — Agent fleet ledger
...
[claim]
# MOD-AGENT-01-agent-fleet-ledger — Agent fleet ledger

[claim]
## §1 Mission

[candidate] 定义 agent_fleet_ledger，让 Codex/Claude/Hermes 分工可审，避免重复写 authority。
...
[claim]
- `docs/research/post-frozen/modules/agent/agent-fleet-ledger.md`
...
[output]
```yaml
dispatch_id: MOD-AGENT-01-agent-fleet-ledger
...
[output]
```yaml
MOD-AGENT-01-agent-fleet-ledger_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
