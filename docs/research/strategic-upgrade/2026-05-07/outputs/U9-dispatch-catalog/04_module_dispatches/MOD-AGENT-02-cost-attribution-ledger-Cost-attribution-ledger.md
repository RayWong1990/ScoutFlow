---
title: MOD-AGENT-02-cost-attribution-ledger — Cost attribution ledger
...
prerequisites:
  ...
  - MOD-AGENT-01-agent-fleet-ledger
blocks:
...
[claim]
# MOD-AGENT-02-cost-attribution-ledger — Cost attribution ledger

[claim]
## §1 Mission

[candidate] 定义 cost_attribution ledger，把 token、runtime、human review cost 作为 candidate evidence。
...
[claim]
- `docs/research/post-frozen/modules/agent/cost-attribution-ledger.md`
...
[output]
```yaml
dispatch_id: MOD-AGENT-02-cost-attribution-ledger
...
[output]
```yaml
MOD-AGENT-02-cost-attribution-ledger_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
