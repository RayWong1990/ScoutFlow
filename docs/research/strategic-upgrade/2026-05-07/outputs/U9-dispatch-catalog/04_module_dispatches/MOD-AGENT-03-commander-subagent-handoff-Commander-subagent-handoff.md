---
title: MOD-AGENT-03-commander-subagent-handoff — Commander subagent handoff
...
prerequisites:
  ...
  - MOD-AGENT-02-cost-attribution-ledger
blocks:
...
[claim]
# MOD-AGENT-03-commander-subagent-handoff — Commander subagent handoff

[claim]
## §1 Mission

[candidate] 把 commander-subagent handoff 写成 preflight/readback contract，保持 subagent 默认 read-only。
...
[boundary] Lane-specific boundary: U5 agent module 只做 ledger / cost / commander contract，不得创建未授权 agent execution path。
...
2. **Pass 2 — scope proof** — Map this task to agent / AGENT and identify exactly which prior proof or partial result is being used; never infer a runtime gate from a candidate doc.
...
[claim]
- `docs/research/post-frozen/modules/agent/commander-subagent-handoff.md`
...
[output]
```yaml
dispatch_id: MOD-AGENT-03-commander-subagent-handoff
...
[output]
```yaml
MOD-AGENT-03-commander-subagent-handoff_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
