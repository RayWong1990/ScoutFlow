---
title: MOD-EGRESS-01-raw-egress-contract — RAW egress contract
...
[claim]
# MOD-EGRESS-01-raw-egress-contract — RAW egress contract

[claim]
## §1 Mission

[candidate] 把 RAW egress contract 写成 manifest/00-Inbox candidate，不把 RAW mirror 写成 repo truth。
...
[claim]
- `docs/research/post-frozen/modules/egress/raw-egress-contract.md`
...
[output]
```yaml
dispatch_id: MOD-EGRESS-01-raw-egress-contract
...
[output]
```yaml
MOD-EGRESS-01-raw-egress-contract_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
