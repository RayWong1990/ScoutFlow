---
title: MOD-EGRESS-02-diloflow-egress-contract — DiloFlow egress contract
...
prerequisites:
  ...
  - MOD-EGRESS-01-raw-egress-contract
blocks:
...
[claim]
# MOD-EGRESS-02-diloflow-egress-contract — DiloFlow egress contract

[claim]
## §1 Mission

[candidate] 定义 DiloFlow egress contract，明确 script seed / delivery note / supersede relation。
...
[claim]
- `docs/research/post-frozen/modules/egress/diloflow-egress-contract.md`
...
[output]
```yaml
dispatch_id: MOD-EGRESS-02-diloflow-egress-contract
...
[output]
```yaml
MOD-EGRESS-02-diloflow-egress-contract_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
