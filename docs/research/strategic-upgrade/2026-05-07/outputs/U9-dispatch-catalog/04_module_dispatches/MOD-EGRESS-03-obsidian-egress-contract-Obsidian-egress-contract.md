---
title: MOD-EGRESS-03-obsidian-egress-contract — Obsidian egress contract
...
prerequisites:
  ...
  - MOD-EGRESS-02-diloflow-egress-contract
blocks:
...
[claim]
# MOD-EGRESS-03-obsidian-egress-contract — Obsidian egress contract

[claim]
## §1 Mission

[candidate] 定义 Obsidian egress contract，避免 vault preview 与 Obsidian long-term knowledge 混层。
...
[claim]
- `docs/research/post-frozen/modules/egress/obsidian-egress-contract.md`
...
[output]
```yaml
dispatch_id: MOD-EGRESS-03-obsidian-egress-contract
...
[output]
```yaml
MOD-EGRESS-03-obsidian-egress-contract_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
