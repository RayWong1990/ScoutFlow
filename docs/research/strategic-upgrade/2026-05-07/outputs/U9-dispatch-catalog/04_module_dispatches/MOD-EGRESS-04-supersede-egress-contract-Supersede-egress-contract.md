---
title: MOD-EGRESS-04-supersede-egress-contract — Supersede egress contract
...
prerequisites:
  ...
  - MOD-EGRESS-03-obsidian-egress-contract
blocks:
...
[claim]
# MOD-EGRESS-04-supersede-egress-contract — Supersede egress contract

[claim]
## §1 Mission

[candidate] 设计 supersede egress contract，让 downstream 能识别 replaced、amended、stale material。
...
[boundary] Lane-specific boundary: U8 egress module 只做 contract / manifest / supersede candidate，不得打开 real downstream writes。
...
2. **Pass 2 — scope proof** — Map this task to egress / EGRESS and identify exactly which prior proof or partial result is being used; never infer a runtime gate from a candidate doc.
...
[claim]
- `docs/research/post-frozen/modules/egress/supersede-egress-contract.md`
...
[output]
```yaml
dispatch_id: MOD-EGRESS-04-supersede-egress-contract
...
[output]
```yaml
MOD-EGRESS-04-supersede-egress-contract_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
