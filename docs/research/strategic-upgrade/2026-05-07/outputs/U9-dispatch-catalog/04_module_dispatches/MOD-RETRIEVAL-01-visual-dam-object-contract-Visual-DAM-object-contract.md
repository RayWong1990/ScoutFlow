---
title: MOD-RETRIEVAL-01-visual-dam-object-contract — Visual DAM object contract
...
[claim]
# MOD-RETRIEVAL-01-visual-dam-object-contract — Visual DAM object contract

[claim]
## §1 Mission

[candidate] 定义 visual-DAM object contract，使 visual asset 与 evidence trace 能被检索而不成为 authority。
...
[claim]
- `docs/research/post-frozen/modules/retrieval/visual-dam-object-contract.md`
...
[output]
```yaml
dispatch_id: MOD-RETRIEVAL-01-visual-dam-object-contract
...
[output]
```yaml
MOD-RETRIEVAL-01-visual-dam-object-contract_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
