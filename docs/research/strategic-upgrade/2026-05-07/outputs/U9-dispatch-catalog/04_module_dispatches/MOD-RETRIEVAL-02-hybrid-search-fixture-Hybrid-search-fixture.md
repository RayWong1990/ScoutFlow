---
title: MOD-RETRIEVAL-02-hybrid-search-fixture — Hybrid search fixture
...
prerequisites:
  ...
  - MOD-RETRIEVAL-01-visual-dam-object-contract
blocks:
...
[claim]
# MOD-RETRIEVAL-02-hybrid-search-fixture — Hybrid search fixture

[claim]
## §1 Mission

[candidate] 设计 hybrid-search fixture，分离 lexical、semantic、citation confidence 与 freshness。
...
[claim]
- `docs/research/post-frozen/modules/retrieval/hybrid-search-fixture.md`
...
[output]
```yaml
dispatch_id: MOD-RETRIEVAL-02-hybrid-search-fixture
...
[output]
```yaml
MOD-RETRIEVAL-02-hybrid-search-fixture_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
