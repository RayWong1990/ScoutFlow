---
title: MOD-RETRIEVAL-03-source-freshness-router — Source freshness router
...
prerequisites:
  ...
  - MOD-RETRIEVAL-02-hybrid-search-fixture
blocks:
...
[claim]
# MOD-RETRIEVAL-03-source-freshness-router — Source freshness router

[claim]
## §1 Mission

[candidate] 建立 source freshness router，识别哪些 vendor/pattern 需要 live refresh，哪些仅可用 paste-time evidence。
...
[claim]
- `docs/research/post-frozen/modules/retrieval/source-freshness-router.md`
...
[output]
```yaml
dispatch_id: MOD-RETRIEVAL-03-source-freshness-router
...
[output]
```yaml
MOD-RETRIEVAL-03-source-freshness-router_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
