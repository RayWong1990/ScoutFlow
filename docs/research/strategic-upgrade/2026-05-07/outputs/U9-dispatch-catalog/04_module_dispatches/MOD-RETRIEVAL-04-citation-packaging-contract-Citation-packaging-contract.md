---
title: MOD-RETRIEVAL-04-citation-packaging-contract — Citation packaging contract
...
owner_tool: GPT Pro / Codex reviewer
...
prerequisites:
  ...
  - MOD-RETRIEVAL-03-source-freshness-router
blocks:
...
[claim]
# MOD-RETRIEVAL-04-citation-packaging-contract — Citation packaging contract

[claim]
## §1 Mission

[candidate] 定义 citation packaging contract，确保 dispatch prompt 的 URL 与 proof artifact 可被 reviewer 追踪。
...
[boundary] Lane-specific boundary: U6 retrieval module 只做 object contract / fixture / citation routing，不得把 hybrid search 当成 knowledge authority。
...
2. **Pass 2 — scope proof** — Map this task to retrieval / RETRIEVAL and identify exactly which prior proof or partial result is being used; never infer a runtime gate from a candidate doc.
...
[claim]
- `docs/research/post-frozen/modules/retrieval/citation-packaging-contract.md`
...
[output]
```yaml
dispatch_id: MOD-RETRIEVAL-04-citation-packaging-contract
...
[output]
```yaml
MOD-RETRIEVAL-04-citation-packaging-contract_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
