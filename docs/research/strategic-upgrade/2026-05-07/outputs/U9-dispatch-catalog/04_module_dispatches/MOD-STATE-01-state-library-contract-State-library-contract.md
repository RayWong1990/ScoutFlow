---
title: MOD-STATE-01-state-library-contract — State library contract
...
[claim]
# MOD-STATE-01-state-library-contract — State library contract

[claim]
## §1 Mission

[candidate] 定义 state-library contract，把 entity/workbench/module 的 state words 收入 candidate appendix。
...
[claim]
- `docs/research/post-frozen/modules/state/state-library-contract.md`
...
[output]
```yaml
dispatch_id: MOD-STATE-01-state-library-contract
...
[output]
```yaml
MOD-STATE-01-state-library-contract_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
