---
title: MOD-VISUAL-02-prompt-template-contract — Prompt template contract
...
prerequisites:
  ...
  - MOD-VISUAL-01-visual-asset-table-creation
blocks:
...
[claim]
# MOD-VISUAL-02-prompt-template-contract — Prompt template contract

[claim]
## §1 Mission

[candidate] 定义 prompt_template contract，让 image/text prompt 能被审计、版本化和回滚。
...
[claim]
- `docs/research/post-frozen/modules/visual/prompt-template-contract.md`
...
[output]
```yaml
dispatch_id: MOD-VISUAL-02-prompt-template-contract
...
[output]
```yaml
MOD-VISUAL-02-prompt-template-contract_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
