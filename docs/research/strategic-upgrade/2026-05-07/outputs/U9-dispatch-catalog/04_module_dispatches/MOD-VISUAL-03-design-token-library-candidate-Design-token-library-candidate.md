---
title: MOD-VISUAL-03-design-token-library-candidate — Design token library candidate
...
prerequisites:
  ...
  - MOD-VISUAL-02-prompt-template-contract
blocks:
...
[claim]
# MOD-VISUAL-03-design-token-library-candidate — Design token library candidate

[claim]
## §1 Mission

[candidate] 建立 design_token library candidate，把 visual spec 与 H5 surface 分开。
...
[claim]
- `docs/research/post-frozen/modules/visual/design-token-library-candidate.md`
...
[output]
```yaml
dispatch_id: MOD-VISUAL-03-design-token-library-candidate
...
[output]
```yaml
MOD-VISUAL-03-design-token-library-candidate_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
