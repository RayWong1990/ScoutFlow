---
title: MOD-VISUAL-04-pattern-library-index — Pattern library index
...
prerequisites:
  ...
  - MOD-VISUAL-03-design-token-library-candidate
blocks:
...
[claim]
# MOD-VISUAL-04-pattern-library-index — Pattern library index

[claim]
## §1 Mission

[candidate] 汇总 pattern_library index，明确哪些来自 paste-time evidence、哪些只是 ScoutFlow 内部候选。
...
[claim]
- `docs/research/post-frozen/modules/visual/pattern-library-index.md`
...
[output]
```yaml
dispatch_id: MOD-VISUAL-04-pattern-library-index
...
[output]
```yaml
MOD-VISUAL-04-pattern-library-index_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
