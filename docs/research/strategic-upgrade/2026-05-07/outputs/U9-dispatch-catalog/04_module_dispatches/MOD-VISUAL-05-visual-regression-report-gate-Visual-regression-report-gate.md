---
title: MOD-VISUAL-05-visual-regression-report-gate — Visual regression report gate
...
prerequisites:
  ...
  - MOD-VISUAL-04-pattern-library-index
blocks:
...
[claim]
# MOD-VISUAL-05-visual-regression-report-gate — Visual regression report gate

[claim]
## §1 Mission

[candidate] 设计 visual regression report gate，强调 manual screenshot verdict 优先于 browser automation。
...
[claim]
- `docs/research/post-frozen/modules/visual/visual-regression-report-gate.md`
...
[output]
```yaml
dispatch_id: MOD-VISUAL-05-visual-regression-report-gate
...
[output]
```yaml
MOD-VISUAL-05-visual-regression-report-gate_COMPLETE: <true|false>
verdict: <clear|concern|reject|partial>
files_count: <int>
files_changed:
  - <path>
