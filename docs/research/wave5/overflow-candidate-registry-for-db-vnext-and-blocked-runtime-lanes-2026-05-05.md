---
title: Overflow candidate registry for DB vNext and blocked runtime lanes
status: candidate
authority: not-authority
execution_approval: not-approved
runtime_approval: not-approved
created_at: 2026-05-05
related_task: T-P1A-154
dispatch_slot: 175
---

# Overflow candidate registry for DB vNext and blocked runtime lanes

> State: candidate / not authority / not execution approval / not runtime approval.

## 1. Scope

Register DB vNext and blocked runtime lanes as overflow candidates only.
...
| --- | --- | --- | --- |
| artifact shape | Overflow candidate registry for DB vNext and blocked runtime lanes scoped note | execution approval | candidate docs only |
...
- Overflow candidate registry for DB vNext and blocked runtime lanes should stay upstream of runtime, migration, and package decisions.
