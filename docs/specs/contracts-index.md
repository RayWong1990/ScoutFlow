...
| docs/SRD-amendments/db-vnext-srd-v3-candidate-2026-05-04.md | `T-P1A-026` candidate amendment on branch / PR | Candidate amendment only；not final authority；not migration approval；not runtime approval |
