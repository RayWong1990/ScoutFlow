...
`Phase 1A — Wave 3A closed; Wave 3B gate=GO but ledger not yet open`
...
| `T-P1A-034` | SRD v3 H5 Bridge PARA vault candidate | `2026-05-05` | PR=#64; merge commit=80ca572; scope=docs/SRD-amendments/h5-bridge-para-vault-srd-v3-candidate-2026-05-04.md; result=bridge/vault route framed as candidate only; not SRD-v3 promoted authority / not runtime approval |
| `T-P1A-033` | PRD v2.1 Strong Visual H5 candidate | `2026-05-05` | PR=#58; merge commit=665f4db; scope=docs/PRD-amendments/prd-v2.1-strong-visual-h5-para-pr-factory-candidate-2026-05-04.md; result=strong visual H5 direction landed as candidate amendment; not promoted base PRD |
