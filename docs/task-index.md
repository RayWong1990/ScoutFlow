...
| `T-P1A-022` | ASR pipeline prestudy | `research/backlog` | — | research note | `docs/research/t-p1a-022-asr-pipeline-prestudy-2026-05-04.md` | `services/**`, `migrations/**`, `audio_transcript` runtime | — | docs-check | `audio_transcript` runtime remains blocked | research lane; not product active; not runtime approval |
